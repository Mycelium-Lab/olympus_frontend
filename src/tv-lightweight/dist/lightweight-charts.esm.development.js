...
var CompositeRenderer = /** @class */ (function () {
    ...
    CompositeRenderer.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
...
var ScaledRenderer = /** @class */ (function () {
    ...
    ScaledRenderer.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
    ...
    ScaledRenderer.prototype._internal_drawBackground = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
    ...
    ScaledRenderer.prototype._internal__drawBackgroundImpl = function (
        ctx,
        isHovered,
        hitTestData
    ) {}
...
var CrosshairMarksPaneView = /** @class */ (function () {
    function CrosshairMarksPaneView(chartModel, crosshair) {
        ...
        this._private__compositeRenderer._internal_setRenderers(
            this._private__markersRenderers
        )
    }
    CrosshairMarksPaneView.prototype._internal_update = function (updateType) {
        ...
        if (serieses.length !== this._private__markersRenderers.length) {
            ...
            this._private__markersRenderers = this._private__markersData.map(
                function (data) {
    ...
    CrosshairMarksPaneView.prototype._internal_renderer = function (
        height,
        width,
        addAnchors
    ) {
    ...
    CrosshairMarksPaneView.prototype._private__updateImpl = function (height) {
        ...
        serieses.forEach(function (s, index) {
            ...
            data._internal_items[0]._internal_y = s
                ._internal_priceScale()
                ._internal_priceToCoordinate(
                    seriesData._internal_price,
                    firstValue._internal_value
                )
            data._internal_backColor =
                (_a = seriesData._internal_borderColor) !== null &&
                _a !== void 0
                    ? _a
                    : _this._private__chartModel._internal_backgroundColorAtYPercentFromTop(
                          data._internal_items[0]._internal_y / height
                      )
            data._internal_items[0]._internal_time = timePointIndex
            data._internal_items[0]._internal_x =
                timeScale._internal_indexToCoordinate(timePointIndex)
...
var CrosshairRenderer = /** @class */ (function () {
    ...
    CrosshairRenderer.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
        ...
        var vertLinesVisible =
            this._private__data._internal_vertLine._internal_visible
        var horzLinesVisible =
            this._private__data._internal_horzLine._internal_visible
        ...
        if (vertLinesVisible && x >= 0) {
            ctx.lineWidth = Math.floor(
                this._private__data._internal_vertLine._internal_lineWidth *
                    pixelRatio
            )
            ctx.strokeStyle =
                this._private__data._internal_vertLine._internal_color
            ctx.fillStyle =
                this._private__data._internal_vertLine._internal_color
            setLineStyle(
                ctx,
                this._private__data._internal_vertLine._internal_lineStyle
            )
            drawVerticalLine(ctx, x, 0, h)
        }
        if (horzLinesVisible && y >= 0) {
            ctx.lineWidth = Math.floor(
                this._private__data._internal_horzLine._internal_lineWidth *
                    pixelRatio
            )
            ctx.strokeStyle =
                this._private__data._internal_horzLine._internal_color
            ctx.fillStyle =
                this._private__data._internal_horzLine._internal_color
            setLineStyle(
                ctx,
                this._private__data._internal_horzLine._internal_lineStyle
            )
...
var CrosshairPaneView = /** @class */ (function () {
    function CrosshairPaneView(source) {
        ...
        this._private__renderer = new CrosshairRenderer(
            this._private__rendererData
        )
    ...
    CrosshairPaneView.prototype._private__updateImpl = function () {
        ...
        var crosshairOptions = pane
            ._internal_model()
            ._internal_options().crosshair
        var data = this._private__rendererData
        data._internal_horzLine._internal_visible =
            visible && this._private__source._internal_horzLineVisible(pane)
        data._internal_vertLine._internal_visible =
            visible && this._private__source._internal_vertLineVisible()
        data._internal_horzLine._internal_lineWidth =
            crosshairOptions.horzLine.width
        data._internal_horzLine._internal_lineStyle =
            crosshairOptions.horzLine.style
        data._internal_horzLine._internal_color =
            crosshairOptions.horzLine.color
        data._internal_vertLine._internal_lineWidth =
            crosshairOptions.vertLine.width
        data._internal_vertLine._internal_lineStyle =
            crosshairOptions.vertLine.style
        data._internal_vertLine._internal_color =
            crosshairOptions.vertLine.color
        ...
        if (matches) {
            return [
                ...
                normalizeAlphaComponent(
                    matches.length < 5 ? 1 : parseFloat(matches[4])
                ),
            ]
        }
    }
...
function gradientColorAtPercent(topColor, bottomColor, percent) {
    var _a = colorStringToRgba(topColor),
        topR = _a[0],
        topG = _a[1],
        topB = _a[2],
        topA = _a[3]
    var _b = colorStringToRgba(bottomColor),
        bottomR = _b[0],
        bottomG = _b[1],
        bottomB = _b[2],
        bottomA = _b[3]
...
var PriceAxisViewRenderer = /** @class */ (function () {
    ...
    PriceAxisViewRenderer.prototype._internal_setData = function (
        data,
        commonData
    ) {
        this._private__data = data
    ...
    PriceAxisViewRenderer.prototype._internal_draw = function (
        ctx,
        rendererOptions,
        textWidthCache,
        width,
        ...
        var tickSize =
            this._private__data._internal_tickVisible ||
            !this._private__data._internal_moveTextToInvisibleTick
        ...
        var textWidth = Math.ceil(
            textWidthCache._internal_measureText(ctx, text)
        )
        var baselineOffset = rendererOptions._internal_baselineOffset
        var totalHeight =
            rendererOptions._internal_fontSize + paddingTop + paddingBottom
        var halfHeigth = Math.ceil(totalHeight * 0.5)
        var totalWidth =
            horzBorder + textWidth + paddingInner + paddingOuter + tickSize
        ...
        if (text) {
            ...
            var horzBorderScaled = Math.max(
                1,
                Math.floor(horzBorder * pixelRatio)
            )
            ...
            var yMidScaled =
                Math.round(yMid * pixelRatio) - Math.floor(pixelRatio * 0.5)
            var yBottomScaled =
                yMidScaled + tickHeight + (yMidScaled - yTopScaled)
            ...
            ctx.fillRect(
                alignRight ? rightScaled - horzBorderScaled : 0,
                yTopScaled,
                horzBorderScaled,
                yBottomScaled - yTopScaled
            )
            ...
            drawScaled(ctx, pixelRatio, function () {
                ctx.fillText(
                    text,
                    xText,
                    yBottom - paddingBottom - baselineOffset
                )
            })
            ctx.restore()
        }
    }
    PriceAxisViewRenderer.prototype._internal_height = function (
        rendererOptions,
        useSecondLine
    ) {
        if (!this._private__data._internal_visible) {
...
var PriceAxisView = /** @class */ (function () {
    function PriceAxisView(ctor) {
        ...
        this._private__invalidated = true
        this._private__axisRenderer = new (ctor || PriceAxisViewRenderer)(
            this._private__axisRendererData,
            this._private__commonRendererData
        )
        this._private__paneRenderer = new (ctor || PriceAxisViewRenderer)(
            this._private__paneRendererData,
            this._private__commonRendererData
        )
    }
    ...
    PriceAxisView.prototype._internal_height = function (
        rendererOptions,
        useSecondLine
    ) {
        if (useSecondLine === void 0) {
            useSecondLine = false
        }
        return Math.max(
            this._private__axisRenderer._internal_height(
                rendererOptions,
                useSecondLine
            ),
            this._private__paneRenderer._internal_height(
                rendererOptions,
                useSecondLine
            )
        )
    ...
    PriceAxisView.prototype._internal_isVisible = function () {
        this._private__updateRendererDataIfNeeded()
        return (
            this._private__axisRendererData._internal_visible ||
            this._private__paneRendererData._internal_visible
        )
    }
    ...
    PriceAxisView.prototype._internal_renderer = function (priceScale) {
        ...
        this._private__axisRendererData._internal_tickVisible =
            this._private__axisRendererData._internal_tickVisible &&
            priceScale._internal_options().drawTicks
        this._private__paneRendererData._internal_tickVisible =
            this._private__paneRendererData._internal_tickVisible &&
            priceScale._internal_options().drawTicks
        this._private__axisRenderer._internal_setData(
            this._private__axisRendererData,
            this._private__commonRendererData
        )
        this._private__paneRenderer._internal_setData(
            this._private__paneRendererData,
            this._private__commonRendererData
        )
    ...
    PriceAxisView.prototype._private__updateRendererDataIfNeeded = function () {
        if (this._private__invalidated) {
            ...
            this._internal__updateRendererData(
                this._private__axisRendererData,
                this._private__paneRendererData,
                this._private__commonRendererData
            )
...
var CrosshairPriceAxisView = /** @class */ (function (_super) {
    ...
    CrosshairPriceAxisView.prototype._internal__updateRendererData = function (
        axisRendererData,
        paneRendererData,
        commonRendererData
    ) {
        ...
        if (
            !this._private__source._internal_visible() ||
            this._private__priceScale._internal_isEmpty() ||
            firstValue === null
        ) {
            return
        }
...
var TimeAxisViewRenderer = /** @class */ (function () {
    ...
    TimeAxisViewRenderer.prototype._internal_draw = function (
        ctx,
        rendererOptions,
        pixelRatio
    ) {
        ...
        if (
            this._private__data === null ||
            this._private__data._internal_visible === false ||
            this._private__data._internal_text.length === 0
        ) {
            return
        }
        ctx.font = rendererOptions._internal_font
        var textWidth = Math.round(
            rendererOptions._internal_widthCache._internal_measureText(
                ctx,
                this._private__data._internal_text,
                optimizationReplacementRe
            )
        )
        if (textWidth <= 0) {
            return
        ...
        if (x1 < 0) {
            ...
            coordinate =
                coordinate - Math.abs(timeScaleWidth - (x1 + labelWidth))
            x1 = Math.floor(coordinate - labelWidthHalf) + 0.5
        }
        ...
        var tickX = Math.round(
            this._private__data._internal_coordinate * pixelRatio
        )
        var tickTop = y1scaled
        var tickBottom = Math.round(
            (tickTop +
                rendererOptions._internal_borderSize +
                rendererOptions._internal_tickLength) *
                pixelRatio
        ...
        drawScaled(ctx, pixelRatio, function () {
            ctx.fillText(
                ensureNotNull(_this._private__data)._internal_text,
                x1 + horzMargin,
                yText
            )
        })
...
var CrosshairTimeAxisView = /** @class */ (function () {
    ...
    CrosshairTimeAxisView.prototype._private__updateImpl = function () {
        ...
        var currentTime = timeScale._internal_indexToTime(
            this._private__crosshair._internal_appliedIndex()
        )
        ...
        data._internal_text = timeScale._internal_formatDateTime(
            ensureNotNull(currentTime)
        )
...
var Crosshair = /** @class */ (function (_super) {
    ...
    function Crosshair(model, options) {
        ...
        _this._private__markersPaneView = new CrosshairMarksPaneView(
            model,
            _this
        )
        var valuePriceProvider = function (
            rawPriceProvider,
            rawCoordinateProvider
        ) {
            return function (priceScale) {
                ...
                if (
                    ...
                    var firstValue = ensureNotNull(
                        priceScale._internal_firstValue()
                    )
                    var price = priceScale._internal_coordinateToPrice(
                        coordinate,
                        firstValue
                    )
                    return {
        ...
        var valueTimeProvider = function (
            rawIndexProvider,
            rawCoordinateProvider
        ) {
            return function () {
                return {
                    _internal_time: _this._private__model
                        ._internal_timeScale()
                        ._internal_indexToTime(rawIndexProvider()),
                    _internal_coordinate: rawCoordinateProvider(),
                }
            }
        }
        // for current position always return both price and coordinate
        _this._private__currentPosPriceProvider = valuePriceProvider(
            function () {
                return _this._private__price
            },
            function () {
                return _this._private__y
            }
        )
        var currentPosTimeProvider = valueTimeProvider(
            function () {
                return _this._private__index
            },
            function () {
                return _this._internal_appliedX()
            }
        )
        _this._private__timeAxisView = new CrosshairTimeAxisView(
            _this,
            model,
            currentPosTimeProvider
        )
    ...
    Crosshair.prototype._internal_paneViews = function (pane) {
        return this._private__pane !== null
            ? [this._private__paneView, this._private__markersPaneView]
            : []
    }
    Crosshair.prototype._internal_horzLineVisible = function (pane) {
        return (
            pane === this._private__pane &&
            this._private__options.horzLine.visible
        )
    }
    ...
    Crosshair.prototype._internal_priceAxisViews = function (pane, priceScale) {
        ...
        if (this._private__pane === pane) {
            views.push(
                this._private__createPriceAxisViewOnDemand(
                    this._private__priceAxisViews,
                    priceScale,
                    this._private__currentPosPriceProvider
                )
            )
        }
        return views
    ...
    Crosshair.prototype._internal_updateAllViews = function () {
        ...
        this._private__priceAxisViews.forEach(function (value) {
            return value._internal_update()
        })
    ...
    Crosshair.prototype._private__tryToUpdateViews = function (
        index,
        price,
        pane
    ) {
    ...
    Crosshair.prototype._private__tryToUpdateData = function (
        newIndex,
        newPrice,
        newPane
    ) {
        ...
        this._private__x = isNaN(newIndex)
            ? NaN
            : this._private__model
                  ._internal_timeScale()
                  ._internal_indexToCoordinate(newIndex)
        this._private__pane = newPane
        var firstValue =
            priceScale !== null ? priceScale._internal_firstValue() : null
        if (priceScale !== null && firstValue !== null) {
            this._private__price = newPrice
            this._private__y = priceScale._internal_priceToCoordinate(
                newPrice,
                firstValue
            )
        } else {
        ...
        return (
            oldX !== this._private__x ||
            oldY !== this._private__y ||
            oldIndex !== this._private__index ||
            oldPrice !== this._private__price ||
            oldPane !== this._private__pane
        )
    }
    Crosshair.prototype._private__setIndexToLastSeriesBarIndex = function () {
        var lastIndexes = this._private__model
            ._internal_serieses()
            .map(function (s) {
                return s._internal_bars()._internal_lastIndex()
            })
            .filter(notNull)
        var lastBarIndex =
            lastIndexes.length === 0 ? null : Math.max.apply(Math, lastIndexes)
        this._private__index = lastBarIndex !== null ? lastBarIndex : NaN
    }
    Crosshair.prototype._private__createPriceAxisViewOnDemand = function (
        map,
        priceScale,
        valueProvider
    ) {
...
var PriceFormatter = /** @class */ (function () {
    ...
    PriceFormatter.prototype._private__formatAsDecimal = function (price) {
        ...
        var fracString = ''
        var fracLength =
            this._internal__fractionalLength !== undefined
                ? this._internal__fractionalLength
                : NaN
        if (base > 1) {
            var fracPart = +(Math.round(price * base) - intPart * base).toFixed(
                this._internal__fractionalLength
            )
            if (fracPart >= base) {
                fracPart -= base
            ...
            fracString =
                formatterOptions._internal_decimalSign +
                numberToStringWithLeadingZero(
                    +fracPart.toFixed(this._internal__fractionalLength) *
                        this._private__minMove,
                    fracLength
                )
        } else {
            ...
            if (fracLength > 0) {
                fracString =
                    formatterOptions._internal_decimalSign +
                    numberToStringWithLeadingZero(0, fracLength)
            }
        }
...
var Delegate = /** @class */ (function () {
    ...
    Delegate.prototype._internal_subscribe = function (
        callback,
        linkedObject,
        singleshot
    ) {
    ...
    Delegate.prototype._internal_unsubscribe = function (callback) {
        var index = this._private__listeners.findIndex(function (listener) {
            return callback === listener._internal_callback
        })
        if (index > -1) {
    ...
    Delegate.prototype._internal_unsubscribeAll = function (linkedObject) {
        this._private__listeners = this._private__listeners.filter(function (
            listener
        ) {
            return listener._internal_linkedObject === linkedObject
        })
    }
    Delegate.prototype._internal_fire = function (param1, param2) {
        var listenersSnapshot = __spreadArray(
            [],
            this._private__listeners,
            true
        )
        this._private__listeners = this._private__listeners.filter(function (
            ...
            return !listener._internal_singleshot
        })
        listenersSnapshot.forEach(function (listener) {
            return listener._internal_callback(param1, param2)
        })
    }
...
var PriceRangeImpl = /** @class */ (function () {
    ...
    PriceRangeImpl.prototype._internal_equals = function (pr) {
        ...
        return (
            this._private__minValue === pr._private__minValue &&
            this._private__maxValue === pr._private__maxValue
        )
    }
    PriceRangeImpl.prototype._internal_clone = function () {
        return new PriceRangeImpl(
            this._private__minValue,
            this._private__maxValue
        )
    }
    ...
    PriceRangeImpl.prototype._internal_isEmpty = function () {
        return (
            this._private__maxValue === this._private__minValue ||
            Number.isNaN(this._private__maxValue) ||
            Number.isNaN(this._private__minValue)
        )
    }
    PriceRangeImpl.prototype._internal_merge = function (anotherRange) {
        ...
        return new PriceRangeImpl(
            Math.min(
                ...
                anotherRange._internal_minValue()
            ),
            Math.max(
                this._internal_maxValue(),
                anotherRange._internal_maxValue()
            )
        )
    }
    ...
    PriceRangeImpl._internal_fromRaw = function (raw) {
        return raw === null
            ? null
            : new PriceRangeImpl(raw.minValue, raw.maxValue)
    }
...
var PriceTickSpanCalculator = /** @class */ (function () {
    ...
    PriceTickSpanCalculator.prototype._internal_tickSpan = function (
        high,
        low,
        maxTickSpan
    ) {
        ...
        while (true) {
            ...
            var haveToContinue =
                ...
                resultTickSpanLargerMaxTickSpan &&
                resultTickSpanLarger1
            if (!haveToContinue) {
                break
            }
            resultTickSpan /= c
            c =
                this._private__integralDividers[
        ...
        if (
            ...
            while (
                ...
                c =
                    this._private__fractionalDividers[
                        ++index % this._private__fractionalDividers.length
                    ]
            }
        }
...
var PriceTickMarkBuilder = /** @class */ (function () {
    function PriceTickMarkBuilder(
        priceScale,
        base,
        coordinateToLogicalFunc,
        logicalToCoordinateFunc
    ) {
    ...
    PriceTickMarkBuilder.prototype._internal_tickSpan = function (high, low) {
        ...
        var spanCalculator1 = new PriceTickSpanCalculator(
            this._private__base,
            [2, 2.5, 2]
        )
        var spanCalculator2 = new PriceTickSpanCalculator(
            this._private__base,
            [2, 2, 2.5]
        )
        var spanCalculator3 = new PriceTickSpanCalculator(
            this._private__base,
            [2.5, 2, 2]
        )
        var spans = []
        spans.push(
            spanCalculator1._internal_tickSpan(high, low, maxTickSpan),
            spanCalculator2._internal_tickSpan(high, low, maxTickSpan),
            spanCalculator3._internal_tickSpan(high, low, maxTickSpan)
        )
        return min(spans)
    }
    PriceTickMarkBuilder.prototype._internal_rebuildTickMarks = function () {
        ...
        var bottom = this._private__coordinateToLogicalFunc(
            scaleHeight - 1,
            firstValue
        )
        var top = this._private__coordinateToLogicalFunc(0, firstValue)
        var extraTopBottomMargin = this._private__priceScale._internal_options()
            .entireTextOnly
            ? this._private__fontHeight() / 2
            : 0
        ...
        for (var logical = high - mod; logical > low; logical -= span) {
            var coord = this._private__logicalToCoordinateFunc(
                logical,
                firstValue,
                true
            )
            ...
            if (
                prevCoord !== null &&
                Math.abs(coord - prevCoord) < this._private__tickMarkHeight()
            ) {
                continue
            }
            ...
            if (targetIndex < this._private__marks.length) {
                ...
                this._private__marks[targetIndex]._internal_label =
                    priceScale._internal_formatLogical(logical)
            } else {
...
function sortSources(sources) {
    return sources.slice().sort(function (s1, s2) {
        return (
            ensureNotNull(s1._internal_zorder()) -
            ensureNotNull(s2._internal_zorder())
        )
    })
}
...
var PriceScale = /** @class */ (function () {
    function PriceScale(id, options, layoutOptions, localizationOptions) {
        ...
        this._private__markBuilder = new PriceTickMarkBuilder(
            this,
            100,
            this._private__coordinateToLogical.bind(this),
            this._private__logicalToCoordinate.bind(this)
        )
    }
    ...
    PriceScale.prototype._internal_applyOptions = function (options) {
        ...
        if (options.scaleMargins !== undefined) {
            ...
            if (top_1 < 0 || top_1 > 1) {
                throw new Error(
                    'Invalid top margin - expect value between 0 and 1, given=' +
                        top_1
                )
            }
    ...
    PriceScale.prototype._internal_setMode = function (newMode) {
        ...
        if (newMode._internal_mode !== undefined) {
            ...
            if (
                newMode._internal_mode === 2 /* Percentage */ ||
        ...
        if (
            oldMode._internal_mode === 1 /* Logarithmic */ &&
        ...
        if (
            newMode._internal_mode === 1 /* Logarithmic */ &&
            newMode._internal_mode !== oldMode._internal_mode
        ) {
        ...
        if (
            modeChanged &&
            (oldMode._internal_mode === 2 /* Percentage */ ||
        ...
        if (
            modeChanged &&
            (oldMode._internal_mode === 3 /* IndexedTo100 */ ||
                this._internal_isIndexedTo100())
        ) {
            this._internal_updateFormatter()
        }
        if (
            newMode._internal_isInverted !== undefined &&
        ...
        this._private__modeChanged._internal_fire(
            oldMode,
            this._internal_mode()
        )
    }
    ...
    PriceScale.prototype._internal_internalHeight = function () {
        ...
        var res =
            ...
            this._private__topMarginPx() -
            this._private__bottomMarginPx()
    ...
    PriceScale.prototype._internal_setPriceRange = function (
        newPriceRange,
        isForceSetValue
    ) {
        ...
        if (
            ...
            (oldPriceRange === null ||
                oldPriceRange._internal_equals(newPriceRange))
        ) {
            return
        }
        this._private__marksCache = null
    ...
    PriceScale.prototype._internal_isEmpty = function () {
        ...
        return (
            this._private__height === 0 ||
            !this._private__priceRange ||
            this._private__priceRange._internal_isEmpty()
        )
    }
    PriceScale.prototype._internal_invertedCoordinate = function (coordinate) {
        return this._internal_isInverted()
            ? coordinate
            : this._internal_height() - 1 - coordinate
    }
    PriceScale.prototype._internal_priceToCoordinate = function (
        price,
        baseValue
    ) {
    ...
    PriceScale.prototype._internal_pointsArrayToCoordinates = function (
        points,
        baseValue,
        visibleRange
    ) {
    ...
    PriceScale.prototype._internal_barPricesToCoordinates = function (
        pricesList,
        baseValue,
        visibleRange
    ) {
        ...
        var fromIndex = visibleRange === undefined ? 0 : visibleRange.from
        var toIndex =
            visibleRange === undefined ? pricesList.length : visibleRange.to
        var transformFn = this._private__getCoordinateTransformer()
        for (var i = fromIndex; i < toIndex; i++) {
    ...
    PriceScale.prototype._internal_coordinateToPrice = function (
        coordinate,
        baseValue
    ) {
    ...
    PriceScale.prototype._internal_logicalToPrice = function (
        logical,
        baseValue
    ) {
        var value = logical
    ...
    PriceScale.prototype._internal_firstValue = function () {
        ...
        var result = null
        for (
            var _i = 0, _a = this._private__dataSources;
            _i < _a.length;
            _i++
        ) {
            var source = _a[_i]
            ...
            if (
                result === null ||
                firstValue._internal_timePoint < result._internal_timePoint
            ) {
                result = firstValue
            }
        }
    ...
    PriceScale.prototype._internal_startScale = function (x) {
        ...
        this._private__priceRangeSnapshot = ensureNotNull(
            this._internal_priceRange()
        )._internal_clone()
    }
    PriceScale.prototype._internal_scaleTo = function (x) {
        ...
        var scaleCoeff =
            (this._private__scaleStartPoint +
                (this._private__height - 1) * 0.2) /
            (x + (this._private__height - 1) * 0.2)
        var newPriceRange = ensureNotNull(
            this._private__priceRangeSnapshot
        )._internal_clone()
    ...
    PriceScale.prototype._internal_scrollTo = function (x) {
        ...
        var priceUnitsPerPixel =
            ensureNotNull(this._internal_priceRange())._internal_length() /
    ...
    PriceScale.prototype._internal_formatPrice = function (price, firstValue) {
        switch (this._private__options.mode) {
            case 2 /* Percentage */:
                return this._internal_formatter().format(
                    toPercent(price, firstValue)
                )
            case 3 /* IndexedTo100 */:
                return this._internal_formatter().format(
                    toIndexedTo100(price, firstValue)
                )
            default:
    ...
    PriceScale.prototype._internal_formatPriceAbsolute = function (price) {
        return this._private__formatPrice(
            price,
            ensureNotNull(
                this._private__formatterSource()
            )._internal_formatter()
        )
    }
    PriceScale.prototype._internal_formatPricePercentage = function (
        price,
        baseValue
    ) {
        price = toPercent(price, baseValue)
    ...
    PriceScale.prototype._internal_recalculatePriceRange = function (
        visibleBars
    ) {
        this._private__invalidatedForRange = {
    ...
    PriceScale.prototype._internal_updateAllViews = function () {
        this._private__dataSources.forEach(function (s) {
            return s._internal_updateAllViews()
        })
    }
    ...
    PriceScale.prototype._private__topMarginPx = function () {
        return this._internal_isInverted()
            ? this._private__options.scaleMargins.bottom *
                  this._internal_height() +
                  this._private__marginBelow
            : this._private__options.scaleMargins.top *
                  this._internal_height() +
    ...
    PriceScale.prototype._private__logicalToCoordinate = function (
        logical,
        baseValue
    ) {
        this._private__makeSureItIsValid()
        ...
        var invCoordinate =
            this._private__bottomMarginPx() +
            ((this._internal_internalHeight() - 1) *
                (logical - range._internal_minValue())) /
                range._internal_length()
        var coordinate = this._internal_invertedCoordinate(invCoordinate)
        return coordinate
    }
    PriceScale.prototype._private__coordinateToLogical = function (
        coordinate,
        baseValue
    ) {
        this._private__makeSureItIsValid()
    ...
    PriceScale.prototype._private__recalculatePriceRangeImpl = function () {
        ...
        for (var _i = 0, sources_1 = sources; _i < sources_1.length; _i++) {
            ...
            var autoScaleInfo = source._internal_autoscaleInfo(
                visibleBars._internal_left(),
                visibleBars._internal_right()
            )
            var sourceRange =
                autoScaleInfo && autoScaleInfo._internal_priceRange()
            if (sourceRange !== null) {
                switch (this._private__options.mode) {
                    case 1 /* Logarithmic */:
                        ...
                        break
                    case 2 /* Percentage */:
                        sourceRange = toPercentRange(
                            sourceRange,
                            firstValue._internal_value
                        )
                        break
                    case 3 /* IndexedTo100 */:
                        sourceRange = toIndexedTo100Range(
                            sourceRange,
                            firstValue._internal_value
                        )
                        break
                ...
                if (priceRange === null) {
                    ...
                    priceRange = priceRange._internal_merge(
                        ensureNotNull(sourceRange)
                    )
                }
        ...
        if (
            marginAbove !== this._private__marginAbove ||
        ...
        if (priceRange !== null) {
            ...
            if (
                priceRange._internal_minValue() ===
                priceRange._internal_maxValue()
            ) {
                var formatterSource = this._private__formatterSource()
                var minMove =
                ...
                priceRange = new PriceRangeImpl(
                    priceRange._internal_minValue() - extendValue,
                    priceRange._internal_maxValue() + extendValue
                )
            }
            this._internal_setPriceRange(priceRange)
        } else {
    ...
    PriceScale.prototype._private__formatPrice = function (
        price,
        fallbackFormatter
    ) {
...
var dd = function (date) {
    return numberToStringWithLeadingZero(getDay(date), 2)
}
var MMMM = function (date, locale) {
    return new Date(
        date.getUTCFullYear(),
        date.getUTCMonth(),
        1
...
var MM = function (date) {
    return numberToStringWithLeadingZero(getMonth(date), 2)
}
var yy = function (date) {
    return numberToStringWithLeadingZero(getYear(date) % 100, 2)
}
var yyyy = function (date) {
    return numberToStringWithLeadingZero(getYear(date), 4)
}
...
var DateFormatter = /** @class */ (function () {
    ...
    DateFormatter.prototype._internal_format = function (date) {
        return formatDate(
            date,
            this._private__dateFormat,
            this._private__locale
        )
    }
...
var TimeFormatter = /** @class */ (function () {
    ...
    TimeFormatter.prototype._internal_format = function (date) {
        return this._private__formatStr
            .replace('%h', numberToStringWithLeadingZero(date.getUTCHours(), 2))
            .replace(
                '%m',
                numberToStringWithLeadingZero(date.getUTCMinutes(), 2)
            )
            .replace(
                '%s',
                numberToStringWithLeadingZero(date.getUTCSeconds(), 2)
            )
    }
...
var DateTimeFormatter = /** @class */ (function () {
    function DateTimeFormatter(params) {
        ...
        this._private__dateFormatter = new DateFormatter(
            formatterParams._internal_dateFormat,
            formatterParams._internal_locale
        )
        this._private__timeFormatter = new TimeFormatter(
            formatterParams._internal_timeFormat
        )
    ...
    DateTimeFormatter.prototype._internal_format = function (dateTime) {
        return (
            '' +
            this._private__dateFormatter._internal_format(dateTime) +
            this._private__separator +
            this._private__timeFormatter._internal_format(dateTime)
        )
    }
...
function defaultTickMarkFormatter(timePoint, tickMarkType, locale) {
    ...
    var date =
        timePoint._internal_businessDay === undefined
            ? new Date(timePoint._internal_timestamp * 1000)
            : new Date(
                  Date.UTC(
                      timePoint._internal_businessDay.year,
                      timePoint._internal_businessDay.month - 1,
                      timePoint._internal_businessDay.day
                  )
              )
    // from given date we should use only as UTC date or timestamp
    // but to format as locale date we can convert UTC date to local date
    var localDateFromUtc = new Date(
        date.getUTCFullYear(),
        date.getUTCMonth(),
        date.getUTCDate(),
        date.getUTCHours(),
...
var FormattedLabelsCache = /** @class */ (function () {
    ...
    FormattedLabelsCache.prototype._internal_format = function (value) {
        var cacheKey =
            value._internal_businessDay === undefined
                ? new Date(value._internal_timestamp * 1000).getTime()
                : new Date(
                      Date.UTC(
                          value._internal_businessDay.year,
                          value._internal_businessDay.month - 1,
                          value._internal_businessDay.day
                      )
                  ).getTime()
        ...
        if (this._private__actualSize === this._private__maxSize) {
            var oldestValue = this._private__tick2Labels.get(
...
var RangeImpl = /** @class */ (function () {
    ...
    RangeImpl.prototype._internal_equals = function (other) {
        return (
            this._private__left === other._internal_left() &&
            this._private__right === other._internal_right()
        )
    }
    return RangeImpl
})()
...
var TickMarks = /** @class */ (function () {
    ...
    TickMarks.prototype._internal_build = function (spacing, maxWidth) {
        ...
        if (
            this._private__cache === null ||
            this._private__cache._internal_maxIndexesPerMark !==
                maxIndexesPerMark
        ) {
            this._private__cache = {
                _internal_marks:
                    this._private__buildMarksImpl(maxIndexesPerMark),
    ...
    TickMarks.prototype._private__buildMarksImpl = function (
        ...
        for (
            var _i = 0,
                _a = Array.from(this._private__marksByWeight.keys()).sort(
                    function (a, b) {
                        return b - a
                    }
                );
            ...
            var currentWeight = ensureDefined(
                this._private__marksByWeight.get(weight)
            )
...
var TimeScaleVisibleRange = /** @class */ (function () {
    ...
    TimeScaleVisibleRange.prototype._internal_strictRange = function () {
        ...
        return new RangeImpl(
            Math.floor(this._private__logicalRange._internal_left()),
            Math.ceil(this._private__logicalRange._internal_right())
        )
    }
...
var TimeScale = /** @class */ (function () {
    ...
    TimeScale.prototype._internal_applyLocalizationOptions = function (
        localizationOptions
    ) {
    ...
    TimeScale.prototype._internal_applyOptions = function (
        options,
        localizationOptions
    ) {
        var _a
        ...
        if (options.minBarSpacing !== undefined) {
            ...
            this._private__model._internal_setBarSpacing(
                (_a = options.barSpacing) !== null && _a !== void 0
                    ? _a
    ...
    TimeScale.prototype._internal_indexToTime = function (index) {
        var _a
        return (
            ((_a = this._private__points[index]) === null || _a === void 0
                ? void 0
                : _a._internal_time) || null
        )
    }
    TimeScale.prototype._internal_timeToIndex = function (time, findNearest) {
        ...
        if (
            ...
            this._private__points[this._private__points.length - 1]
                ._internal_time._internal_timestamp
        ) {
            // special case
    ...
    TimeScale.prototype._internal_timeRangeForLogicalRange = function (range) {
        ...
        return {
            from: ensureNotNull(
                this._internal_indexToTime(Math.max(firstIndex, from))
            ),
            to: ensureNotNull(
                this._internal_indexToTime(Math.min(lastIndex, to))
            ),
        }
    }
    ...
    TimeScale.prototype._internal_setWidth = function (width) {
        ...
        if (
            this._private__options.lockVisibleTimeRangeOnResize &&
            this._private__width
        ) {
            // recalculate bar spacing
            var newBarSpacing =
                (this._private__barSpacing * width) / this._private__width
            ...
            if (visibleRange !== null) {
                ...
                if (firstVisibleBar <= 0) {
                    ...
                    this._private__rightOffset -=
                        Math.round(delta / this._private__barSpacing) + 1
                }
            }
        }
    ...
    TimeScale.prototype._internal_indexToCoordinate = function (index) {
        ...
        var coordinate =
            this._private__width -
            (deltaFromRight + 0.5) * this._private__barSpacing -
            1
        return coordinate
    }
    TimeScale.prototype._internal_indexesToCoordinates = function (
        points,
        visibleRange
    ) {
        var baseIndex = this._internal_baseIndex()
    ...
    TimeScale.prototype._internal_marks = function () {
        ...
        var firstBar = Math.max(
            visibleBars._internal_left(),
            visibleBars._internal_left() - indexPerLabel
        )
        var lastBar = Math.max(
            visibleBars._internal_right(),
            visibleBars._internal_right() - indexPerLabel
        )
        var items = this._private__tickMarks._internal_build(
            spacing,
            maxLabelWidth
        )
        // according to indexPerLabel value this value means "earliest index which _might be_ used as the second label on time scale"
        var earliestIndexOfSecondLabel =
            this._private__firstIndex() + indexPerLabel
        ...
        for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
            ...
            if (
                !(
                    firstBar <= tm._internal_index &&
                    tm._internal_index <= lastBar
                )
            ) {
                continue
            }
            ...
            if (targetIndex < this._private__labels.length) {
                ...
                label._internal_coord = this._internal_indexToCoordinate(
                    tm._internal_index
                )
                ...
                label = {
                    ...
                    _internal_coord: this._internal_indexToCoordinate(
                        tm._internal_index
                    ),
            ...
            if (this._private__barSpacing > maxLabelWidth / 2) {
                ...
                label._internal_needAlignCoordinate =
                    (this._private__options.fixLeftEdge &&
                        tm._internal_index <= earliestIndexOfSecondLabel) ||
                    (this._private__options.fixRightEdge &&
                        tm._internal_index >= indexOfSecondLastLabel)
            }
            targetIndex++
        }
    ...
    TimeScale.prototype._internal_zoom = function (zoomPoint, scale) {
        var floatIndexAtZoomPoint =
            this._private__coordinateToFloatIndex(zoomPoint)
        ...
        if (!this._private__options.rightBarStaysOnScroll) {
            ...
            this._internal_setRightOffset(
                this._internal_rightOffset() +
                    (floatIndexAtZoomPoint -
                        this._private__coordinateToFloatIndex(zoomPoint))
            )
        }
    }
    ...
    TimeScale.prototype._internal_scaleTo = function (x) {
        ...
        var startLengthFromRight = clamp(
            this._private__width - x,
            0,
            this._private__width
        )
        var currentLengthFromRight = clamp(
            this._private__width -
                ensureNotNull(this._private__scaleStartPoint),
            0,
            this._private__width
        )
        ...
        this._internal_setBarSpacing(
            (this._private__commonTransitionStartState._internal_barSpacing *
                startLengthFromRight) /
    ...
    TimeScale.prototype._internal_scrollTo = function (x) {
        ...
        var shiftInLogical =
            (this._private__scrollStartPoint - x) / this._internal_barSpacing()
        this._private__rightOffset =
            ensureNotNull(this._private__commonTransitionStartState)
                ._internal_rightOffset + shiftInLogical
        this._private__visibleRangeInvalidated = true
        // do not allow scroll out of visible bars
        this._private__correctOffset()
    }
    ...
    TimeScale.prototype._internal_scrollToRealTime = function () {
        this._internal_scrollToOffsetAnimated(
            this._private__options.rightOffset
        )
    }
    TimeScale.prototype._internal_scrollToOffsetAnimated = function (
        offset,
        animationDuration
    ) {
        var _this = this
        if (animationDuration === void 0) {
            animationDuration = 400 /* DefaultAnimationDuration */
        }
        if (!isFinite(offset)) {
    ...
    TimeScale.prototype._internal_setVisibleRange = function (range) {
        ...
        this._private__rightOffset =
            range._internal_right() - this._internal_baseIndex()
        this._private__correctOffset()
        this._private__visibleRangeInvalidated = true
        this._private__model._internal_recalculateAllPanes()
        this._private__model._internal_lightUpdate()
    ...
    TimeScale.prototype._internal_fitContent = function () {
        ...
        this._internal_setVisibleRange(
            new RangeImpl(first, last + this._private__options.rightOffset)
        )
    }
    ...
    TimeScale.prototype._internal_formatDateTime = function (time) {
        if (this._private__localizationOptions.timeFormatter !== undefined) {
            return this._private__localizationOptions.timeFormatter(
                time._internal_businessDay || time._internal_timestamp
            )
        }
        return this._private__dateTimeFormatter._internal_format(
            new Date(time._internal_timestamp * 1000)
        )
    }
    ...
    TimeScale.prototype._private__updateVisibleRange = function () {
        ...
        if (this._internal_isEmpty()) {
            this._private__setVisibleRange(
                TimeScaleVisibleRange._internal_invalid()
            )
            return
        }
        var baseIndex = this._internal_baseIndex()
    ...
    TimeScale.prototype._private__saveCommonTransitionsStartState =
        function () {
    ...
    TimeScale.prototype._private__clearCommonTransitionsStartState =
        function () {
            this._private__commonTransitionStartState = null
        }
    ...
    TimeScale.prototype._private__formatLabelImpl = function (
        timePoint,
        weight
    ) {
        var _a
        ...
        if (this._private__options.tickMarkFormatter !== undefined) {
            ...
            return this._private__options.tickMarkFormatter(
                (_a = timePoint._internal_businessDay) !== null && _a !== void 0
                    ? _a
                    : timePoint._internal_timestamp,
                tickMarkType,
                this._private__localizationOptions.locale
            )
        }
    ...
    TimeScale.prototype._private__setVisibleRange = function (newVisibleRange) {
        ...
        if (
            !areRangesEqual(
                oldVisibleRange._internal_strictRange(),
                this._private__visibleRange._internal_strictRange()
            )
        ) {
        ...
        if (
            !areRangesEqual(
                oldVisibleRange._internal_logicalRange(),
                this._private__visibleRange._internal_logicalRange()
            )
        ) {
    ...
    TimeScale.prototype._private__updateDateTimeFormatter = function () {
        ...
        if (this._private__options.timeVisible) {
            this._private__dateTimeFormatter = new DateTimeFormatter({
                ...
                _internal_timeFormat: this._private__options.secondsVisible
                    ? '%h:%m:%s'
                    : '%h:%m',
                _internal_dateTimeSeparator: '   ',
            ...
            this._private__dateTimeFormatter = new DateFormatter(
                dateFormat,
                this._private__localizationOptions.locale
            )
        }
...
var PriceAxisRendererOptionsProvider = /** @class */ (function () {
    ...
    PriceAxisRendererOptionsProvider.prototype._internal_options = function () {
        ...
        if (
            ...
            rendererOptions._internal_fontSize = currentFontSize
            rendererOptions._internal_fontFamily = currentFontFamily
            rendererOptions._internal_font = makeFont(
                currentFontSize,
                currentFontFamily
            )
            rendererOptions._internal_paddingTop = Math.floor(
                currentFontSize / 3.5
            )
            rendererOptions._internal_paddingBottom =
                rendererOptions._internal_paddingTop
            rendererOptions._internal_paddingInner = Math.max(
                Math.ceil(
                    currentFontSize / 2 -
                        rendererOptions._internal_tickLength / 2
                ),
                0
            )
            rendererOptions._internal_paddingOuter = Math.ceil(
                currentFontSize / 2 + rendererOptions._internal_tickLength / 2
            )
            rendererOptions._internal_baselineOffset = Math.round(
                currentFontSize / 10
            )
        }
    ...
    PriceAxisRendererOptionsProvider.prototype._private__textColor =
        function () {
            return this._private__chartModel._internal_options().layout
                .textColor
        }
    PriceAxisRendererOptionsProvider.prototype._private__fontSize =
        function () {
            return this._private__chartModel._internal_options().layout.fontSize
        }
    PriceAxisRendererOptionsProvider.prototype._private__fontFamily =
        function () {
            return this._private__chartModel._internal_options().layout
                .fontFamily
        }
...
function mergePaneInvalidation(beforeValue, newValue) {
    ...
    var autoScale =
        beforeValue._internal_autoScale || newValue._internal_autoScale
...
var InvalidateMask = /** @class */ (function () {
    ...
    InvalidateMask.prototype._internal_invalidatePane = function (
        paneIndex,
        invalidation
    ) {
    ...
    InvalidateMask.prototype._internal_invalidateForPane = function (
        paneIndex
    ) {
        ...
        return {
            _internal_level: Math.max(
                this._private__globalLevel,
                paneInvalidation._internal_level
            ),
    ...
    InvalidateMask.prototype._internal_merge = function (other) {
        ...
        this._private__timeScaleInvalidations =
            this._private__timeScaleInvalidations.concat(
                other._private__timeScaleInvalidations
            )
        for (
            var _i = 0, _a = other._private__timeScaleInvalidations;
            _i < _a.length;
            _i++
        ) {
        ...
        this._private__globalLevel = Math.max(
            this._private__globalLevel,
            other._private__globalLevel
        )
        other._private__invalidatedPanes.forEach(function (
            invalidation,
            index
        ) {
    ...
    InvalidateMask.prototype._private__applyTimeScaleInvalidation = function (
        invalidation
    ) {
...
var VolumeFormatter = /** @class */ (function () {
    ...
    VolumeFormatter.prototype._private__formatNumber = function (value) {
        ...
        return res.replace(/(\.[1-9]*)0+$/, function (e, p1) {
            return p1
        })
    }
    ...
    PaneRendererAreaBase.prototype._internal__drawImpl = function (ctx) {
        ...
        if (this._internal__data._internal_items.length === 1) {
            ...
            walkLine(
                ctx,
                this._internal__data._internal_items,
                this._internal__data._internal_lineType,
                this._internal__data._internal_visibleRange
            )
            if (
                this._internal__data._internal_visibleRange.to >
                this._internal__data._internal_visibleRange.from
            ) {
                ctx.lineTo(
                    this._internal__data._internal_items[
...
var PaneRendererLineBase = /** @class */ (function (_super) {
    ...
    PaneRendererLineBase.prototype._internal__drawImpl = function (ctx) {
        ...
        if (this._internal__data._internal_items.length === 1) {
            var point = this._internal__data._internal_items[0]
            ctx.moveTo(
                point._internal_x - this._internal__data._internal_barWidth / 2,
                point._internal_y
            )
            ctx.lineTo(
                point._internal_x + this._internal__data._internal_barWidth / 2,
...
function visibleTimedValues(items, range, extendedRange) {
    ...
    if (
        from > 0 &&
        from < items.length &&
        items[from]._internal_time >= firstBar
    ) {
        extendedFrom = from - 1
    }
    if (
        to > 0 &&
        to < items.length &&
        items[to - 1]._internal_time <= lastBar
    ) {
        extendedTo = to + 1
    }
...
var SeriesPaneViewBase = /** @class */ (function () {
    ...
    SeriesPaneViewBase.prototype._internal__updatePoints = function () {
        ...
        this._internal__itemsVisibleRange = visibleTimedValues(
            this._internal__items,
            visibleBars,
            this._private__extendedVisibleRange
        )
        this._internal__convertToCoordinates(
            priceScale,
            timeScale,
            firstValue._internal_value
        )
...
var LinePaneViewBase = /** @class */ (function (_super) {
    ...
    LinePaneViewBase.prototype._internal__convertToCoordinates = function (
        priceScale,
        timeScale,
        firstValue
    ) {
        timeScale._internal_indexesToCoordinates(
            this._internal__items,
            undefinedIfNull(this._internal__itemsVisibleRange)
        )
        priceScale._internal_pointsArrayToCoordinates(
            this._internal__items,
            firstValue,
            undefinedIfNull(this._internal__itemsVisibleRange)
        )
    }
    LinePaneViewBase.prototype._internal__createRawItemBase = function (
        time,
        price
    ) {
        return {
    ...
    LinePaneViewBase.prototype._internal__fillRawPoints = function () {
        ...
        this._internal__items = this._internal__series
            ._internal_bars()
            ._internal_rows()
            .map(function (row) {
                var value = row._internal_value[3 /* Close */]
                return _this._internal__createRawItem(
                    row._internal_index,
                    value,
                    colorer
                )
...
var SeriesAreaPaneView = /** @class */ (function (_super) {
    ...
    function SeriesAreaPaneView(series, model) {
        ...
        _this._private__renderer._internal_setRenderers([
            _this._private__areaRenderer,
            _this._private__lineRenderer,
        ])
        return _this
    }
...
var PaneRendererBars = /** @class */ (function () {
    ...
    PaneRendererBars.prototype._internal_draw = function (
        ...
        if (
            this._private__data === null ||
            this._private__data._internal_bars.length === 0 ||
        ...
        this._private__barLineWidth = this._private__data._internal_thinBars
            ? Math.min(this._private__barWidth, Math.floor(pixelRatio))
            : this._private__barWidth
        var prevColor = null
        var drawOpenClose =
            this._private__barLineWidth <= this._private__barWidth &&
            this._private__data._internal_barSpacing >=
                Math.floor(1.5 * pixelRatio)
        for (
            var i = this._private__data._internal_visibleRange.from;
            i < this._private__data._internal_visibleRange.to;
            ++i
        ) {
            ...
            if (drawOpenClose) {
                if (this._private__data._internal_openVisible) {
                    ...
                    var openTop = Math.max(
                        bodyTop,
                        Math.round(bar._internal_openY * pixelRatio) -
                            bodyWidthHalf
                    )
                ...
                var closeTop = Math.max(
                    bodyTop,
                    Math.round(bar._internal_closeY * pixelRatio) -
                        bodyWidthHalf
                )
    ...
    PaneRendererBars.prototype._private__calcBarWidth = function (pixelRatio) {
        ...
        return Math.max(
            ...
            Math.floor(
                optimalBarWidth(
                    ensureNotNull(this._private__data)._internal_barSpacing,
                    pixelRatio
                )
            )
        )
...
var BarsPaneViewBase = /** @class */ (function (_super) {
    ...
    BarsPaneViewBase.prototype._internal__convertToCoordinates = function (
        priceScale,
        timeScale,
        firstValue
    ) {
        ...
        priceScale._internal_barPricesToCoordinates(
            this._internal__items,
            firstValue,
            undefinedIfNull(this._internal__itemsVisibleRange)
        )
    }
    BarsPaneViewBase.prototype._internal__createDefaultItem = function (
        time,
        bar,
        colorer
    ) {
...
var SeriesBarsPaneView = /** @class */ (function (_super) {
    ...
    SeriesBarsPaneView.prototype._internal_renderer = function (height, width) {
        ...
        var data = {
            ...
            _internal_barSpacing: this._internal__model
                ._internal_timeScale()
                ._internal_barSpacing(),
    ...
    SeriesBarsPaneView.prototype._internal__updateOptions = function () {
        ...
        this._internal__items.forEach(function (item) {
            item._internal_color = _this._internal__series
                ._internal_barColorer()
                ._internal_barStyle(item._internal_time)._internal_barColor
        })
    }
    SeriesBarsPaneView.prototype._internal__createRawItem = function (
        time,
        bar,
        colorer
    ) {
        return __assign(
            __assign({}, this._internal__createDefaultItem(time, bar, colorer)),
            {
                _internal_color:
                    colorer._internal_barStyle(time)._internal_barColor,
            }
        )
    }
...
var PaneRendererCandlesticks = /** @class */ (function () {
    ...
    PaneRendererCandlesticks.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
        ...
        this._private__barWidth = optimalCandlestickWidth(
            this._private__data._internal_barSpacing,
            pixelRatio
        )
        // grid and crosshair have line width = Math.floor(pixelRatio)
        ...
        if (this._private__data._internal_wickVisible) {
            this._private__drawWicks(
                ctx,
                bars,
                this._private__data._internal_visibleRange,
                pixelRatio
            )
        }
        ...
        if (
            !this._private__data._internal_borderVisible ||
            this._private__barWidth > borderWidth * 2
        ) {
            this._private__drawCandles(
                ctx,
                bars,
                this._private__data._internal_visibleRange,
                pixelRatio
    ...
    PaneRendererCandlesticks.prototype._private__drawWicks = function (
        ctx,
        bars,
        visibleRange,
        pixelRatio
        ...
        var prevWickColor = ''
        var wickWidth = Math.min(
            Math.floor(pixelRatio),
            Math.floor(this._private__data._internal_barSpacing * pixelRatio)
        )
        wickWidth = Math.max(
            Math.floor(pixelRatio),
            Math.min(wickWidth, this._private__barWidth)
        )
        ...
        for (var i = visibleRange.from; i < visibleRange.to; i++) {
            ...
            var top_1 = Math.round(
                Math.min(bar._internal_openY, bar._internal_closeY) * pixelRatio
            )
            var bottom = Math.round(
                Math.max(bar._internal_openY, bar._internal_closeY) * pixelRatio
            )
    ...
    PaneRendererCandlesticks.prototype._private__calculateBorderWidth =
        function (pixelRatio) {
            ...
            if (this._private__barWidth <= res * 2) {
                ...
                return Math.max(
                    Math.floor(pixelRatio),
                    Math.floor(1 /* BarBorderWidth */ * pixelRatio)
                )
            }
            return res
        }
    PaneRendererCandlesticks.prototype._private__drawBorder = function (
        ctx,
        bars,
        visibleRange,
        barSpacing,
        ...
        for (var i = visibleRange.from; i < visibleRange.to; i++) {
            ...
            var left =
                Math.round(bar._internal_x * pixelRatio) -
                Math.floor(this._private__barWidth * 0.5)
            // this is important to calculate right before patching left
            var right = left + this._private__barWidth - 1
            var top_2 = Math.round(
                Math.min(bar._internal_openY, bar._internal_closeY) * pixelRatio
            )
            var bottom = Math.round(
                Math.max(bar._internal_openY, bar._internal_closeY) * pixelRatio
            ...
            if (
                this._private__data._internal_barSpacing * pixelRatio >
                2 * borderWidth
            ) {
                fillRectInnerBorder(
                    ctx,
    ...
    PaneRendererCandlesticks.prototype._private__drawCandles = function (
        ctx,
        bars,
        visibleRange,
        pixelRatio
...
var SeriesCandlesticksPaneView = /** @class */ (function (_super) {
    ...
    SeriesCandlesticksPaneView.prototype._internal_renderer = function (
        height,
        width
    ) {
        if (!this._internal__series._internal_visible()) {
    ...
    SeriesCandlesticksPaneView.prototype._internal__updateOptions =
        function () {
            var _this = this
            this._internal__items.forEach(function (item) {
                var style = _this._internal__series
                    ._internal_barColorer()
                    ._internal_barStyle(item._internal_time)
    ...
    SeriesCandlesticksPaneView.prototype._internal__createRawItem = function (
        time,
        bar,
        colorer
    ) {
        ...
        return __assign(
            __assign({}, this._internal__createDefaultItem(time, bar, colorer)),
            {
                ...
                _internal_wickColor: style._internal_barWickColor,
                _internal_borderColor: style._internal_barBorderColor,
            }
        )
    }
...
var PaneRendererHistogram = /** @class */ (function () {
    ...
    PaneRendererHistogram.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
        ...
        if (
            this._private__data === null ||
            this._private__data._internal_items.length === 0 ||
            this._private__data._internal_visibleRange === null
        ) {
            return
        }
        ...
        var tickWidth = Math.max(1, Math.floor(pixelRatio))
        var histogramBase = Math.round(
            this._private__data._internal_histogramBase * pixelRatio
        )
        ...
        for (
            ...
            var current =
                this._private__precalculatedCache[
                    i - this._private__data._internal_visibleRange.from
                ]
            ...
            ctx.fillRect(
                current._internal_left,
                top_1,
                current._internal_right - current._internal_left + 1,
                bottom - top_1
            )
        }
    }
    ...
    PaneRendererHistogram.prototype._private__fillPrecalculatedCache =
        function (pixelRatio) {
            ...
            this._private__precalculatedCache = new Array(
                this._private__data._internal_visibleRange.to -
                    this._private__data._internal_visibleRange.from
            )
            for (
                var i = this._private__data._internal_visibleRange.from;
                i < this._private__data._internal_visibleRange.to;
            ...
            // correct positions
            for (
                var i = this._private__data._internal_visibleRange.from + 1;
                i < this._private__data._internal_visibleRange.to;
                i++
            ) {
                var current =
                ...
                var prev =
                    this._private__precalculatedCache[
                        i - this._private__data._internal_visibleRange.from - 1
                    ]
                if (current._internal_time !== prev._internal_time + 1) {
                    continue
                }
                if (
                    current._internal_left - prev._internal_right !==
                    spacing + 1
                ) {
                    // have to align
                    if (prev._internal_roundedCenter > prev._internal_center) {
                        // prev wasshifted to left, so add pixel to right
                        prev._internal_right =
                            current._internal_left - spacing - 1
                    } else {
                        // extend current to left
                        current._internal_left =
                            prev._internal_right + spacing + 1
                    }
                }
            }
            var minWidth = Math.ceil(
                this._private__data._internal_barSpacing * pixelRatio
            )
            for (
                var i = this._private__data._internal_visibleRange.from;
            ...
            if (spacing > 0 && minWidth < alignToMinimalWidthLimit) {
                for (
                    ...
                    if (width > minWidth) {
                        if (
                            current._internal_roundedCenter >
                            current._internal_center
                        ) {
...
var SeriesHistogramPaneView = /** @class */ (function (_super) {
    ...
    SeriesHistogramPaneView.prototype._internal_renderer = function (
        height,
        width
    ) {
        if (!this._internal__series._internal_visible()) {
    ...
    SeriesHistogramPaneView.prototype._internal__fillRawPoints = function () {
        var barSpacing = this._internal__model
            ._internal_timeScale()
            ._internal_barSpacing()
        ...
        for (
            var _i = 0,
                _a = this._internal__series._internal_bars()._internal_rows();
            _i < _a.length;
            _i++
        ) {
            var row = _a[_i]
        ...
        this._private__compositeRenderer._internal_setRenderers([
            this._private__renderer,
        ])
    }
    SeriesHistogramPaneView.prototype._internal__updateOptions = function () {}
    SeriesHistogramPaneView.prototype._internal__clearVisibleRange =
        function () {
            _super.prototype._internal__clearVisibleRange.call(this)
            this._private__histogramData._internal_visibleRange = null
        }
    SeriesHistogramPaneView.prototype._internal__convertToCoordinates =
        function (priceScale, timeScale, firstValue) {
            if (this._internal__itemsVisibleRange === null) {
                return
            }
            var barSpacing = timeScale._internal_barSpacing()
            var visibleBars = ensureNotNull(
                timeScale._internal_visibleStrictRange()
            )
            var histogramBase = priceScale._internal_priceToCoordinate(
                this._internal__series._internal_options().base,
                firstValue
            )
            timeScale._internal_indexesToCoordinates(
            ...
            this._private__histogramData._internal_visibleRange =
                visibleTimedValues(
                    this._private__histogramData._internal_items,
                    visibleBars,
                    false
...
var SeriesLinePaneView = /** @class */ (function (_super) {
    ...
    SeriesLinePaneView.prototype._internal__createRawItem = function (
        time,
        price
    ) {
        return this._internal__createRawItemBase(time, price)
...
var TextWidthCache = /** @class */ (function () {
    ...
    TextWidthCache.prototype._internal_measureText = function (
        ctx,
        text,
        optimizationReplacementRe
    ) {
        ...
        if (width === undefined) {
            ...
            this._private__keysIndex =
                (this._private__keysIndex + 1) % this._private__keys.length
...
var PanePriceAxisViewRenderer = /** @class */ (function () {
    ...
    PanePriceAxisViewRenderer.prototype._internal_setParams = function (
    ...
    PanePriceAxisViewRenderer.prototype._internal_draw = function (
        ctx,
        pixelRatio
    ) {
        if (
        ...
        this._private__priceAxisViewRenderer._internal_draw(
            ctx,
            this._private__rendererOptions,
            this._private__textWidthCache,
            this._private__width,
            this._private__align,
            pixelRatio
        )
    }
...
var PanePriceAxisView = /** @class */ (function () {
    function PanePriceAxisView(priceAxisView, dataSource, chartModel) {
        ...
        this._private__renderer = new PanePriceAxisViewRenderer(
            this._private__textWidthCache
        )
    }
    PanePriceAxisView.prototype._internal_renderer = function (height, width) {
        var pane = this._private__chartModel._internal_paneForSource(
            this._private__dataSource
        )
        if (pane === null) {
            return null
        }
        // this price scale will be used to find label placement only (left, right, none)
        var priceScale = pane._internal_isOverlay(this._private__dataSource)
            ? pane._internal_defaultPriceScale()
            : this._private__dataSource._internal_priceScale()
        if (priceScale === null) {
            return null
        }
        ...
        var options =
            this._private__chartModel._internal_priceAxisRendererOptions()
        ...
        this._private__renderer._internal_setParams(
...
var HorizontalLineRenderer = /** @class */ (function () {
    ...
    HorizontalLineRenderer.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
        ...
        if (
            y < 0 ||
            y > Math.ceil(this._private__data._internal_height * pixelRatio)
        ) {
            return
        }
        ...
        ctx.lineWidth = Math.floor(
            this._private__data._internal_lineWidth * pixelRatio
        )
...
var SeriesHorizontalLinePaneView = /** @class */ (function () {
    function SeriesHorizontalLinePaneView(series) {
        ...
        this._internal__lineRenderer._internal_setData(
            this._internal__lineRendererData
        )
    }
    ...
    SeriesHorizontalLinePaneView.prototype._internal_renderer = function (
        height,
        width
    ) {
        if (!this._internal__series._internal_visible()) {
...
var SeriesHorizontalBaseLinePaneView = /** @class */ (function (_super) {
    ...
    SeriesHorizontalBaseLinePaneView.prototype._internal__updateImpl =
        function (height, width) {
            ...
            if (
                ...
                !this._internal__series._internal_visible()
            ) {
                return
            }
            var firstValue = this._internal__series._internal_firstValue()
            ...
            this._internal__lineRendererData._internal_y =
                priceScale._internal_priceToCoordinate(
                    firstValue._internal_value,
                    firstValue._internal_value
                )
            this._internal__lineRendererData._internal_width = width
            this._internal__lineRendererData._internal_height = height
            this._internal__lineRendererData._internal_color =
                seriesOptions.baseLineColor
            this._internal__lineRendererData._internal_lineWidth =
                seriesOptions.baseLineWidth
            this._internal__lineRendererData._internal_lineStyle =
                seriesOptions.baseLineStyle
        }
...
var SeriesLastPriceAnimationRenderer = /** @class */ (function () {
    ...
    SeriesLastPriceAnimationRenderer.prototype._internal_setData = function (
        data
    ) {
        this._private__data = data
    }
    ...
    SeriesLastPriceAnimationRenderer.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
        ...
        var centerX =
            Math.round(data._internal_center.x * pixelRatio) + correction // correct x coordinate only
        var centerY = data._internal_center.y * pixelRatio
        ctx.fillStyle = data._internal_seriesLineColor
        ctx.beginPath()
        var centerPointRadius =
            Math.max(2, data._internal_seriesLineWidth * 1.5) * pixelRatio
        ...
        ctx.arc(
            centerX,
            centerY,
            data._internal_radius * pixelRatio,
            0,
            2 * Math.PI,
            false
        )
        ...
        ctx.arc(
            centerX,
            centerY,
            data._internal_radius * pixelRatio + tickWidth / 2,
            0,
            2 * Math.PI,
            false
        )
...
function animationData(durationSinceStart, lineColor) {
    var globalStage =
        (durationSinceStart % 2600) /* AnimationPeriod */ /
        2600 /* AnimationPeriod */
    var currentStageData
    for (
        var _i = 0, animationStagesData_1 = animationStagesData;
        _i < animationStagesData_1.length;
        _i++
    ) {
        var stageData = animationStagesData_1[_i]
        if (
            globalStage >= stageData._internal_start &&
            globalStage <= stageData._internal_end
        ) {
    ...
    assert(
        ...
        'Last price animation internal logic error'
    )
    var subStage =
        (globalStage - currentStageData._internal_start) /
        (currentStageData._internal_end - currentStageData._internal_start)
    return {
        _internal_fillColor: color(
            lineColor,
            subStage,
            currentStageData._internal_startFillAlpha,
            currentStageData._internal_endFillAlpha
        ),
        _internal_strokeColor: color(
            lineColor,
            subStage,
            currentStageData._internal_startStrokeAlpha,
            currentStageData._internal_endStrokeAlpha
        ),
        _internal_radius: radius(
            subStage,
            currentStageData._internal_startRadius,
            currentStageData._internal_endRadius
        ),
    }
}
var SeriesLastPriceAnimationPaneView = /** @class */ (function () {
    ...
    SeriesLastPriceAnimationPaneView.prototype._internal_update = function (
        ...
        if (updateType === 'data') {
            if (
                this._private__series._internal_options().lastPriceAnimation ===
                2 /* OnDataUpdate */
            ) {
    ...
    SeriesLastPriceAnimationPaneView.prototype._internal_invalidateStage =
        function () {
            this._private__stageInvalidated = true
        }
    ...
    SeriesLastPriceAnimationPaneView.prototype._internal_animationActive =
        function () {
            switch (
                this._private__series._internal_options().lastPriceAnimation
            ) {
    ...
    SeriesLastPriceAnimationPaneView.prototype._internal_renderer = function (
        height,
        width
    ) {
        if (this._private__invalidated) {
    ...
    SeriesLastPriceAnimationPaneView.prototype._private__updateImpl = function (
        height,
        width
    ) {
        this._private__renderer._internal_setData(null)
        var timeScale = this._private__series
            ._internal_model()
            ._internal_timeScale()
        ...
        var lastValuePoint = {
            ...
            y: this._private__series
                ._internal_priceScale()
                ._internal_priceToCoordinate(
                    lastValue._internal_price,
                    firstValue._internal_value
                ),
        }
        var seriesLineColor = lastValue._internal_color
        var seriesLineWidth =
            this._private__series._internal_options().lineWidth
    ...
    SeriesLastPriceAnimationPaneView.prototype._private__updateRendererDataStage =
        function () {
            var rendererData = this._private__renderer._internal_data()
            if (rendererData !== null) {
                var data = animationData(
                    this._private__duration(),
                    rendererData._internal_seriesLineColor
                )
    ...
    SeriesLastPriceAnimationPaneView.prototype._private__duration =
        function () {
            return this._internal_animationActive()
                ? performance.now() - this._private__startTime
                : 2600 /* AnimationPeriod */ - 1
        }
...
function size(barSpacing, coeff) {
    var result =
        Math.min(
            Math.max(barSpacing, 12 /* MinShapeSize */),
            30 /* MaxShapeSize */
        ) * coeff
...
var SeriesMarkersRenderer = /** @class */ (function (_super) {
    ...
    SeriesMarkersRenderer.prototype._internal_setParams = function (
        fontSize,
        fontFamily
    ) {
        if (
    ...
    SeriesMarkersRenderer.prototype._internal__drawImpl = function (
        ctx,
        isHovered,
        hitTestData
    ) {
        ...
        for (
            ...
            if (item._internal_text !== undefined) {
                item._internal_text._internal_width =
                    this._private__textWidthCache._internal_measureText(
                        ctx,
                        item._internal_text._internal_content
                    )
...
function drawItem(item, ctx) {
    ...
    if (item._internal_text !== undefined) {
        drawText(
            ctx,
            item._internal_text._internal_content,
            item._internal_x - item._internal_text._internal_width / 2,
            item._internal_text._internal_y
        )
    }
    drawShape(item, ctx)
}
...
function hitTestItem(item, x, y) {
    if (
        item._internal_text !== undefined &&
        hitTestText(
            item._internal_x,
            item._internal_text._internal_y,
            item._internal_text._internal_width,
            item._internal_text._internal_height,
            x,
            y
        )
    ) {
...
function fillSizeAndY(
    ...
    var shapeSize =
        calculateShapeHeight(timeScale._internal_barSpacing()) * sizeMultiplier
    var halfSize = shapeSize / 2
    rendererItem._internal_size = shapeSize
    switch (marker.position) {
        case 'inBar': {
            rendererItem._internal_y = priceScale._internal_priceToCoordinate(
                inBarPrice,
                firstValue
            )
            if (rendererItem._internal_text !== undefined) {
                rendererItem._internal_text._internal_y =
                    rendererItem._internal_y +
                    halfSize +
                    shapeMargin +
                    textHeight * (0.5 + 0.1) /* TextMargin */
            }
            return
        }
        case 'aboveBar': {
            rendererItem._internal_y =
                priceScale._internal_priceToCoordinate(highPrice, firstValue) -
                halfSize -
                offsets._internal_aboveBar
            if (rendererItem._internal_text !== undefined) {
                rendererItem._internal_text._internal_y =
                    rendererItem._internal_y -
                    halfSize -
        ...
        case 'belowBar': {
            rendererItem._internal_y =
                priceScale._internal_priceToCoordinate(lowPrice, firstValue) +
                halfSize +
                offsets._internal_belowBar
            if (rendererItem._internal_text !== undefined) {
                rendererItem._internal_text._internal_y =
                    rendererItem._internal_y +
                    halfSize +
...
var SeriesMarkersPaneView = /** @class */ (function () {
    ...
    SeriesMarkersPaneView.prototype._internal_renderer = function (
        height,
        width,
        addAnchors
    ) {
    ...
    SeriesMarkersPaneView.prototype._internal_autoScaleMargins = function () {
        if (this._private__autoScaleMarginsInvalidated) {
            if (this._private__series._internal_indexedMarkers().length > 0) {
                var barSpacing = this._private__model
                    ._internal_timeScale()
                    ._internal_barSpacing()
                var shapeMargin$1 = shapeMargin(barSpacing)
                var marginsAboveAndBelow =
                    calculateShapeHeight(barSpacing) * 1.5 + shapeMargin$1 * 2
    ...
    SeriesMarkersPaneView.prototype._internal__makeValid = function () {
        ...
        if (this._private__dataInvalidated) {
            this._private__data._internal_items = seriesMarkers.map(function (
                marker
            ) {
                return {
        ...
        this._private__data._internal_visibleRange = visibleTimedValues(
            this._private__data._internal_items,
            visibleBars,
            true
        )
        for (
            var index = this._private__data._internal_visibleRange.from;
            index < this._private__data._internal_visibleRange.to;
            index++
        ) {
            ...
            rendererItem._internal_x = timeScale._internal_indexToCoordinate(
                marker.time
            )
...
var SeriesPriceLinePaneView = /** @class */ (function (_super) {
    ...
    SeriesPriceLinePaneView.prototype._internal__updateImpl = function (
        height,
        width
    ) {
        ...
        var seriesOptions = this._internal__series._internal_options()
        if (
            !seriesOptions.priceLineVisible ||
            !this._internal__series._internal_visible()
        ) {
            return
        }
        var lastValueData = this._internal__series._internal_lastValueData(
            seriesOptions.priceLineSource === 0 /* LastBar */
        )
        ...
        data._internal_color = this._internal__series._internal_priceLineColor(
            lastValueData._internal_color
        )
...
var SeriesPriceAxisView = /** @class */ (function (_super) {
    ...
    SeriesPriceAxisView.prototype._internal__updateRendererData = function (
        axisRendererData,
        paneRendererData,
        commonRendererData
    ) {
        ...
        var showPriceAndPercentage =
            seriesOptions.seriesLastValueMode ===
        ...
        if (showSeriesLastValue) {
            axisRendererData._internal_text = this._internal__axisText(
                lastValueData,
                showSeriesLastValue,
                showPriceAndPercentage
            )
            axisRendererData._internal_visible =
                axisRendererData._internal_text.length !== 0
        }
        if (showSymbolLabel || showPriceAndPercentage) {
            paneRendererData._internal_text = this._internal__paneText(
                lastValueData,
                showSeriesLastValue,
                showSymbolLabel,
                showPriceAndPercentage
            )
            paneRendererData._internal_visible =
                paneRendererData._internal_text.length > 0
        }
        var lastValueColor = source._internal_priceLineColor(
            lastValueData._internal_color
        )
        var colors = generateContrastColors(lastValueColor)
        commonRendererData._internal_background = colors._internal_background
        commonRendererData._internal_color = colors._internal_foreground
        commonRendererData._internal_coordinate =
            lastValueData._internal_coordinate
        paneRendererData._internal_borderColor = source
            ._internal_model()
            ._internal_backgroundColorAtYPercentFromTop(
                lastValueData._internal_coordinate /
                    source._internal_priceScale()._internal_height()
            )
        axisRendererData._internal_borderColor = lastValueColor
    }
    SeriesPriceAxisView.prototype._internal__paneText = function (
        lastValue,
        showSeriesLastValue,
        showSymbolLabel,
        showPriceAndPercentage
        ...
        if (showSeriesLastValue && showPriceAndPercentage) {
            result += this._private__source
                ._internal_priceScale()
                ._internal_isPercentage()
                ? lastValue._internal_formattedPriceAbsolute
                : lastValue._internal_formattedPricePercentage
        }
        return result.trim()
    }
    SeriesPriceAxisView.prototype._internal__axisText = function (
        lastValueData,
        showSeriesLastValue,
        showPriceAndPercentage
    ) {
        ...
        return this._private__source
            ._internal_priceScale()
            ._internal_isPercentage()
            ? lastValueData._internal_formattedPricePercentage
            : lastValueData._internal_formattedPriceAbsolute
    }
...
var AutoscaleInfoImpl = /** @class */ (function () {
    ...
    AutoscaleInfoImpl._internal_fromRaw = function (raw) {
        return raw === null
            ? null
            : new AutoscaleInfoImpl(
                  PriceRangeImpl._internal_fromRaw(raw.priceRange),
                  raw.margins
              )
    }
...
var CustomPriceLinePaneView = /** @class */ (function (_super) {
    ...
    CustomPriceLinePaneView.prototype._internal__updateImpl = function (
        height,
        width
    ) {
        var data = this._internal__lineRendererData
...
var CustomPriceLinePriceAxisView = /** @class */ (function (_super) {
    ...
    CustomPriceLinePriceAxisView.prototype._internal__updateRendererData =
        function (axisRendererData, paneRendererData, commonData) {
            axisRendererData._internal_visible = false
            paneRendererData._internal_visible = false
            ...
            paneRendererData._internal_borderColor = series
                ._internal_model()
                ._internal_backgroundColorAtYPercentFromTop(
                    y / series._internal_priceScale()._internal_height()
                )
            axisRendererData._internal_text = series
                ._internal_priceScale()
                ._internal_formatPriceAbsolute(options.price)
            axisRendererData._internal_visible = true
...
var CustomPriceLine = /** @class */ (function () {
    function CustomPriceLine(series, options) {
        ...
        this._private__priceAxisView = new CustomPriceLinePriceAxisView(
            series,
            this
        )
        this._private__panePriceAxisView = new PanePriceAxisView(
            this._private__priceAxisView,
            series,
            series._internal_model()
        )
    }
    ...
    CustomPriceLine.prototype._internal_yCoord = function () {
        ...
        return priceScale._internal_priceToCoordinate(
            this._private__options.price,
            firstValue._internal_value
        )
    }
...
var SeriesBarColorer = /** @class */ (function () {
    ...
    SeriesBarColorer.prototype._internal_barStyle = function (
        barIndex,
        precomputedBars
    ) {
        ...
        switch (targetType) {
            ...
            case 'Candlestick':
                return this._private__candleStyle(
                    seriesOptions,
                    barIndex,
                    precomputedBars
                )
            case 'Histogram':
                return this._private__histogramStyle(
                    seriesOptions,
                    barIndex,
                    precomputedBars
                )
    ...
    SeriesBarColorer.prototype._private__barStyle = function (
        barStyle,
        barIndex,
        precomputedBars
    ) {
        ...
        var isUp =
            ensure(currentBar._internal_value[0 /* Open */]) <=
            ensure(currentBar._internal_value[3 /* Close */])
        result._internal_barColor = isUp ? upColor : downColor
        result._internal_barBorderColor = isUp ? borderUpColor : borderDownColor
        return result
    }
    SeriesBarColorer.prototype._private__candleStyle = function (
        candlestickStyle,
        barIndex,
        precomputedBars
    ) {
    ...
    SeriesBarColorer.prototype._private__histogramStyle = function (
        histogramStyle,
        barIndex,
        precomputedBars
    ) {
        ...
        result._internal_barColor =
            currentBar._internal_color !== undefined
                ? currentBar._internal_color
                : histogramStyle.color
        return result
    }
    SeriesBarColorer.prototype._private__findBar = function (
        barIndex,
        precomputedBars
    ) {
...
var PlotList = /** @class */ (function () {
    ...
    PlotList.prototype._internal_lastIndex = function () {
        return this._internal_size() > 0
            ? this._private__indexAt(this._private__items.length - 1)
            : null
    }
    ...
    PlotList.prototype._internal_search = function (index, searchMode) {
        ...
        return __assign(__assign({}, this._private__valueAt(pos)), {
    ...
    PlotList.prototype._internal_minMaxOnRangeCached = function (
        start,
        end,
        plots
    ) {
        ...
        for (var _i = 0, plots_1 = plots; _i < plots_1.length; _i++) {
            var plot = plots_1[_i]
            var plotMinMax = this._private__minMaxOnRangeCachedImpl(
                start,
                end,
                plot
            )
    ...
    PlotList.prototype._private__searchNearestLeft = function (index) {
        ...
        return nearestLeftPos !== this._private__items.length &&
            this._private__indexAt(nearestLeftPos) < index
            ? nearestLeftPos
            : null
    }
    PlotList.prototype._private__searchNearestRight = function (index) {
        var nearestRightPos = this._private__upperbound(index)
        return nearestRightPos !== this._private__items.length &&
            index < this._private__indexAt(nearestRightPos)
            ? nearestRightPos
            : null
    }
    PlotList.prototype._private__bsearch = function (index) {
        ...
        if (
            start !== this._private__items.length &&
            !(index < this._private__items[start]._internal_index)
        ) {
            return start
        }
        return null
    ...
    PlotList.prototype._private__lowerbound = function (index) {
        return lowerbound(this._private__items, index, function (a, b) {
            return a._internal_index < b
        })
    }
    PlotList.prototype._private__upperbound = function (index) {
        return upperbound(this._private__items, index, function (a, b) {
    ...
    PlotList.prototype._private__minMaxOnRangeCachedImpl = function (
        ...
        var cachedHigh = Math.max(
            cachedLow,
            Math.floor(e / CHUNK_SIZE) * CHUNK_SIZE
        )
        {
            var startIndex = this._private__lowerbound(s)
            var endIndex = this._private__upperbound(
                Math.min(e, cachedLow, end)
            ) // non-inclusive end
            var plotMinMax = this._private__plotMinMax(
                startIndex,
                endIndex,
                plotIndex
            )
        ...
        for (
            ...
            if (chunkMinMax === undefined) {
                var chunkStart = this._private__lowerbound(
                    chunkIndex * CHUNK_SIZE
                )
                var chunkEnd = this._private__upperbound(
                    (chunkIndex + 1) * CHUNK_SIZE - 1
                )
                chunkMinMax = this._private__plotMinMax(
                    chunkStart,
                    chunkEnd,
                    plotIndex
                )
...
var Series = /** @class */ (function (_super) {
    ...
    function Series(model, options, seriesType) {
        ...
        _this._private__baseHorizontalLineView =
            new SeriesHorizontalBaseLinePaneView(_this)
        ...
        _this._private__panePriceAxisView = new PanePriceAxisView(
            priceAxisView,
            _this,
            model
        )
    ...
    Series.prototype._internal_lastValueData = function (globalLast) {
        ...
        if (
            this._internal_model()._internal_timeScale()._internal_isEmpty() ||
            priceScale._internal_isEmpty() ||
            this._private__data._internal_isEmpty()
        ) {
            return noDataRes
        }
        var visibleBars = this._internal_model()
            ._internal_timeScale()
        ...
        if (globalLast) {
            ...
            var endBar = this._private__data._internal_search(
                visibleBars._internal_right(),
                -1 /* NearestLeft */
            )
            if (endBar === null) {
        ...
        var style = barColorer._internal_barStyle(lastIndex, {
            _internal_value: bar,
        })
        var coordinate = priceScale._internal_priceToCoordinate(
            price,
            firstValue._internal_value
        )
        return {
            ...
            _internal_formattedPriceAbsolute:
                priceScale._internal_formatPriceAbsolute(price),
            _internal_formattedPricePercentage:
                priceScale._internal_formatPricePercentage(
                    price,
                    firstValue._internal_value
                ),
            _internal_color: style._internal_barColor,
    ...
    Series.prototype._internal_applyOptions = function (options) {
        ...
        if (
            ...
            targetPriceScaleId !== this._private__options.priceScaleId
        ) {
            // series cannot do it itself, ask model
            this._internal_model()._internal_moveSeriesToScale(
                this,
                targetPriceScaleId
            )
        }
    ...
    Series.prototype._internal_setData = function (data) {
        ...
        ;(_a = this._private__lastPriceAnimationPaneView) === null ||
        _a === void 0
            ? void 0
            : _a._internal_update('data')
    ...
    Series.prototype._internal_setMarkers = function (data) {
        this._private__markers = data.map(function (item) {
    ...
    Series.prototype._internal_dataAt = function (time) {
        ...
        if (
            this._private__seriesType === 'Bar' ||
            this._private__seriesType === 'Candlestick'
        ) {
            return {
    ...
    Series.prototype._internal_topPaneViews = function (pane) {
        ...
        if (
            animationPaneView === null ||
            !animationPaneView._internal_visible()
        ) {
            return []
        }
        if (
            this._private__animationTimeoutId === null &&
            animationPaneView._internal_animationActive()
        ) {
    ...
    Series.prototype._internal_paneViews = function () {
        ...
        for (
            var _i = 0, _a = this._private__customPriceLines;
            _i < _a.length;
            _i++
        ) {
    ...
    Series.prototype._internal_priceAxisViews = function (pane, priceScale) {
        if (
            priceScale !== this._internal__priceScale &&
            !this._private__isOverlay()
        ) {
            return []
        }
    ...
    Series.prototype._internal_autoscaleInfo = function (
        startTimePoint,
        endTimePoint
    ) {
        var _this = this
        if (this._private__options.autoscaleInfoProvider !== undefined) {
            var autoscaleInfo = this._private__options.autoscaleInfoProvider(
                function () {
                    var res = _this._private__autoscaleInfoImpl(
                        startTimePoint,
                        endTimePoint
                    )
    ...
    Series.prototype._internal_updateAllViews = function () {
        ...
        this._private__markersPaneView._internal_update()
        for (
            var _i = 0, _b = this._private__priceAxisViews;
            _i < _b.length;
            _i++
        ) {
        ...
        for (
            var _c = 0, _d = this._private__customPriceLines;
            _c < _d.length;
            _c++
        ) {
    ...
    Series.prototype._private__autoscaleInfoImpl = function (
        startTimePoint,
        endTimePoint
    ) {
        if (
        ...
        var plots =
            ...
            this._private__seriesType === 'Histogram'
                ? [3 /* Close */]
                : [2 /* Low */, 1 /* High */]
        var barsMinMax = this._private__data._internal_minMaxOnRangeCached(
            startTimePoint,
            endTimePoint,
            plots
        )
        var range =
            barsMinMax !== null
                ? new PriceRangeImpl(
                      barsMinMax._internal_min,
                      barsMinMax._internal_max
                  )
                : null
        if (this._internal_seriesType() === 'Histogram') {
            ...
            range =
                range !== null
                    ? range._internal_merge(rangeWithBase)
                    : rangeWithBase
        }
        return new AutoscaleInfoImpl(
            range,
            this._private__markersPaneView._internal_autoScaleMargins()
        )
    }
    ...
    Series.prototype._private__markerBackgroundColor = function (index) {
        ...
        return this._internal_barColorer()._internal_barStyle(index)
            ._internal_barColor
    }
    Series.prototype._private__recreateFormatter = function () {
        switch (this._private__options.priceFormat.type) {
            ...
            case 'volume': {
                this._private__formatter = new VolumeFormatter(
                    this._private__options.priceFormat.precision
                )
                break
            }
            case 'percent': {
                this._private__formatter = new PercentageFormatter(
                    this._private__options.priceFormat.precision
                )
                break
            }
            default: {
                var priceScale = Math.pow(
                    10,
                    this._private__options.priceFormat.precision
                )
                this._private__formatter = new PriceFormatter(
                    priceScale,
                    this._private__options.priceFormat.minMove * priceScale
                )
            }
        }
    ...
    Series.prototype._private__recalculateMarkers = function () {
        ...
        if (
            timeScale._internal_isEmpty() ||
            this._private__data._internal_size() === 0
        ) {
            this._private__indexedMarkers = []
            return
        }
        var firstDataIndex = ensureNotNull(
            this._private__data._internal_firstIndex()
        )
        this._private__indexedMarkers = this._private__markers.map(function (
            marker,
            index
        ) {
            // the first find index on the time scale (across all series)
            var timePointIndex = ensureNotNull(
                timeScale._internal_timeToIndex(marker.time, true)
            )
            ...
            var searchMode =
                timePointIndex < firstDataIndex
                    ? 1 /* NearestRight */
                    : -1 /* NearestLeft */
            var seriesDataIndex = ensureNotNull(
                _this._private__data._internal_search(
                    timePointIndex,
                    searchMode
                )
            )._internal_index
    ...
    Series.prototype._private__recreatePaneViews = function () {
        this._private__markersPaneView = new SeriesMarkersPaneView(
            this,
            this._internal_model()
        )
        switch (this._private__seriesType) {
            case 'Bar': {
                this._private__paneView = new SeriesBarsPaneView(
                    this,
                    this._internal_model()
                )
                break
            ...
            case 'Candlestick': {
                this._private__paneView = new SeriesCandlesticksPaneView(
                    this,
                    this._internal_model()
                )
                break
            ...
            case 'Line': {
                this._private__paneView = new SeriesLinePaneView(
                    this,
                    this._internal_model()
                )
                break
            ...
            case 'Histogram': {
                this._private__paneView = new SeriesHistogramPaneView(
                    this,
                    this._internal_model()
                )
                break
            ...
            default:
                throw Error(
                    'Unknown chart style assigned: ' + this._private__seriesType
                )
        }
    }
    return Series
...
var Magnet = /** @class */ (function () {
    ...
    Magnet.prototype._internal_align = function (price, index, pane) {
        ...
        var serieses = pane._internal_dataSources().filter(function (ds) {
            return ds instanceof Series
        })
        var candidates = serieses.reduce(function (acc, series) {
            if (
                pane._internal_isOverlay(series) ||
                !series._internal_visible()
            ) {
                return acc
            }
            ...
            return acc.concat([
                ps._internal_priceToCoordinate(
                    bar._internal_value[3 /* Close */],
        ...
        candidates.sort(function (y1, y2) {
            return Math.abs(y1 - y) - Math.abs(y2 - y)
        })
...
var GridRenderer = /** @class */ (function () {
    ...
    GridRenderer.prototype._internal_draw = function (
        ctx,
        pixelRatio,
        isHovered,
        hitTestData
        ...
        strokeInPixel(ctx, function () {
            ...
            if (data._internal_vertLinesVisible) {
                ...
                ctx.beginPath()
                for (
                    var _i = 0, _a = data._internal_timeMarks;
                    _i < _a.length;
                    _i++
                ) {
                    var timeMark = _a[_i]
            ...
            if (data._internal_horzLinesVisible) {
                ...
                ctx.beginPath()
                for (
                    var _b = 0, _c = data._internal_priceMarks;
                    _b < _c.length;
                    _b++
                ) {
                    var priceMark = _c[_b]
...
var GridPaneView = /** @class */ (function () {
    ...
    GridPaneView.prototype._internal_renderer = function (height, width) {
        if (this._private__invalidated) {
            var gridOptions = this._private__pane
                ._internal_model()
                ._internal_options().grid
            var data = {
                _internal_h: height,
                _internal_w: width,
                ...
                _internal_priceMarks: this._private__pane
                    ._internal_defaultPriceScale()
                    ._internal_marks(),
                _internal_timeMarks:
                    this._private__pane
...
var Pane = /** @class */ (function () {
    function Pane(timeScale, model) {
        ...
        this._private__rightPriceScale = this._private__createPriceScale(
            'right' /* Right */,
        ...
        this._private__leftPriceScale
            ...
            ._internal_subscribe(
                this._private__onPriceScaleModeChanged.bind(
                    this,
                    this._private__leftPriceScale
                ),
                this
    ...
    Pane.prototype._internal_applyScaleOptions = function (options) {
        if (options.leftPriceScale) {
            this._private__leftPriceScale._internal_applyOptions(
                options.leftPriceScale
            )
        }
        if (options.rightPriceScale) {
            this._private__rightPriceScale._internal_applyOptions(
                options.rightPriceScale
            )
        }
        ...
        if (options.overlayPriceScales) {
            var sourceArrays = Array.from(
                this._private__overlaySourcesByScaleId.values()
            )
            for (
                var _i = 0, sourceArrays_1 = sourceArrays;
                _i < sourceArrays_1.length;
                _i++
            ) {
    ...
    Pane.prototype._internal_priceScaleById = function (id) {
        ...
        if (this._private__overlaySourcesByScaleId.has(id)) {
            return ensureDefined(
                this._private__overlaySourcesByScaleId.get(id)
            )[0]._internal_priceScale()
        }
        return null
    }
    ...
    Pane.prototype._internal_isOverlay = function (source) {
        ...
        return (
            this._private__leftPriceScale !== priceScale &&
            this._private__rightPriceScale !== priceScale
        )
    }
    Pane.prototype._internal_addDataSource = function (
        source,
        targetScaleId,
        zOrder
    ) {
        var targetZOrder =
            zOrder !== undefined
                ? zOrder
                : this._private__getZOrderMinMax()._internal_maxZOrder + 1
    ...
    Pane.prototype._internal_removeDataSource = function (source) {
        ...
        this._private__dataSources.splice(index, 1)
        var priceScaleId = ensureNotNull(
            source._internal_priceScale()
        )._internal_id()
        if (this._private__overlaySourcesByScaleId.has(priceScaleId)) {
            var overlaySources = ensureDefined(
                this._private__overlaySourcesByScaleId.get(priceScaleId)
            )
        ...
        if (
            priceScale &&
            priceScale._internal_dataSources().indexOf(source) >= 0
        ) {
    ...
    Pane.prototype._internal_defaultPriceScale = function () {
        var priceScale = null
        if (
            this._private__model._internal_options().rightPriceScale.visible &&
            this._private__rightPriceScale._internal_dataSources().length !== 0
        ) {
            priceScale = this._private__rightPriceScale
        } else if (
            this._private__model._internal_options().leftPriceScale.visible &&
            this._private__leftPriceScale._internal_dataSources().length !== 0
        ) {
    ...
    Pane.prototype._internal_resetPriceScale = function (priceScale) {
        var visibleBars =
            this._private__timeScale._internal_visibleStrictRange()
    ...
    Pane.prototype._internal_orderedSources = function () {
        if (this._private__cachedOrderedSources === null) {
            this._private__cachedOrderedSources = sortSources(
                this._private__dataSources
            )
        }
        return this._private__cachedOrderedSources
    ...
    Pane.prototype._private__recalculatePriceScaleImpl = function (priceScale) {
        ...
        if (
            ...
            !this._private__timeScale._internal_isEmpty()
        ) {
            var visibleBars =
                this._private__timeScale._internal_visibleStrictRange()
            if (visibleBars !== null) {
    ...
    Pane.prototype._private__insertDataSource = function (
        source,
        priceScaleId,
        zOrder
    ) {
        ...
        if (priceScale === null) {
            priceScale = this._private__createPriceScale(
                priceScaleId,
        ...
        if (!isDefaultPriceScale(priceScaleId)) {
            ...
            this._private__overlaySourcesByScaleId.set(
                priceScaleId,
                overlaySources
            )
        }
    ...
    Pane.prototype._private__onPriceScaleModeChanged = function (
        priceScale,
        oldMode,
        newMode
    ) {
    ...
    Pane.prototype._private__createPriceScale = function (id, options) {
        var actualOptions = __assign(
            { visible: true, autoScale: true },
            clone(options)
        )
        var priceScale = new PriceScale(
            id,
            actualOptions,
            this._private__model._internal_options().layout,
            this._private__model._internal_options().localization
        )
...
var WatermarkRenderer = /** @class */ (function (_super) {
    ...
    WatermarkRenderer.prototype._internal__drawBackgroundImpl = function (ctx) {
        ...
        var textHeight = 0
        for (
            var _i = 0, _a = this._private__data._internal_lines;
            _i < _a.length;
            _i++
        ) {
            var line = _a[_i]
            ...
            if (textWidth > this._private__data._internal_width) {
                line._internal_zoom =
                    this._private__data._internal_width / textWidth
            } else {
        ...
        switch (this._private__data._internal_vertAlign) {
            ...
            case 'center':
                vertOffset = Math.max(
                    (this._private__data._internal_height - textHeight) / 2,
                    0
                )
                break
            case 'bottom':
                vertOffset = Math.max(
                    this._private__data._internal_height - textHeight,
                    0
                )
                break
        }
        ctx.fillStyle = this._private__data._internal_color
        for (
            var _b = 0, _c = this._private__data._internal_lines;
            _b < _c.length;
            _b++
        ) {
            var line = _c[_b]
            ...
            switch (this._private__data._internal_horzAlign) {
                ...
                case 'right':
                    ctx.textAlign = 'right'
                    horzOffset =
                        this._private__data._internal_width -
                        1 -
                        line._internal_lineHeight / 2
                    break
            }
...
var WatermarkPaneView = /** @class */ (function () {
    function WatermarkPaneView(source) {
        ...
        this._private__renderer = new WatermarkRenderer(
            this._private__rendererData
        )
        this._private__source = source
    }
    ...
    WatermarkPaneView.prototype._private__updateImpl = function (
        height,
        width
    ) {
...
var ChartModel = /** @class */ (function () {
    function ChartModel(invalidateHandler, options) {
        ...
        this._private__options = options
        this._private__rendererOptionsProvider =
            new PriceAxisRendererOptionsProvider(this)
        this._private__timeScale = new TimeScale(
            this,
            options.timeScale,
            this._private__options.localization
        )
        ...
        this._private__panes[0]._internal_setStretchFactor(
            DEFAULT_STRETCH_FACTOR * 2
        )
        this._private__backgroundTopColor = this._private__getBackgroundColor(
            0 /* Top */
        )
        this._private__backgroundBottomColor =
            this._private__getBackgroundColor(1 /* Bottom */)
    }
    ...
    ChartModel.prototype._internal_applyOptions = function (options) {
        merge(this._private__options, options)
        this._private__panes.forEach(function (p) {
            return p._internal_applyScaleOptions(options)
        })
        if (options.timeScale !== undefined) {
            this._private__timeScale._internal_applyOptions(options.timeScale)
        }
        if (options.localization !== undefined) {
            this._private__timeScale._internal_applyLocalizationOptions(
    ...
    ChartModel.prototype._internal_applyPriceScaleOptions = function (
        priceScaleId,
        options
    ) {
    ...
    ChartModel.prototype._internal_setWidth = function (width) {
        ...
        this._private__panes.forEach(function (pane) {
            return pane._internal_setWidth(width)
        })
        this._internal_recalculateAllPanes()
    }
    ChartModel.prototype._internal_createPane = function (index) {
        ...
        var actualIndex =
            index === undefined ? this._private__panes.length - 1 : index
    ...
    ChartModel.prototype._internal_startScalePrice = function (
        pane,
        priceScale,
        x
    ) {
    ...
    ChartModel.prototype._internal_scalePriceTo = function (
        pane,
        priceScale,
        x
    ) {
        ...
        this._private__invalidate(
            this._private__paneInvalidationMask(pane, 2 /* Light */)
        )
    }
    ...
    ChartModel.prototype._internal_startScrollPrice = function (
        pane,
        priceScale,
        x
    ) {
    ...
    ChartModel.prototype._internal_scrollPriceTo = function (
        pane,
        priceScale,
        x
    ) {
    ...
    ChartModel.prototype._internal_endScrollPrice = function (
        pane,
        priceScale
    ) {
        if (priceScale._internal_isAutoScale()) {
    ...
    ChartModel.prototype._internal_resetPriceScale = function (
        pane,
        priceScale
    ) {
    ...
    ChartModel.prototype._internal_setAndSaveCurrentPosition = function (
        x,
        y,
        pane
    ) {
        ...
        if (visibleBars !== null) {
            index = Math.min(
                Math.max(visibleBars._internal_left(), index),
                visibleBars._internal_right()
            )
        }
        ...
        this._private__crosshairMoved._internal_fire(
            this._private__crosshair._internal_appliedIndex(),
            { x: x, y: y }
        )
    }
    ...
    ChartModel.prototype._internal_updateTimeScale = function (
        ...
        if (
            ...
            var isLastSeriesBarVisible =
                visibleBars._internal_contains(currentBaseIndex)
            var isLeftBarShiftToLeft =
                oldFirstTime._internal_timestamp >
                newFirstTime._internal_timestamp
            var isSeriesPointsAdded =
                newBaseIndex !== null && newBaseIndex > currentBaseIndex
            var isSeriesPointsAddedToRight =
                isSeriesPointsAdded && !isLeftBarShiftToLeft
            var needShiftVisibleRangeOnNewBar =
                isLastSeriesBarVisible &&
                this._private__timeScale._internal_options()
                    .shiftVisibleRangeOnNewBar
            if (isSeriesPointsAddedToRight && !needShiftVisibleRangeOnNewBar) {
                var compensationShift = newBaseIndex - currentBaseIndex
                this._private__timeScale._internal_setRightOffset(
                    this._private__timeScale._internal_rightOffset() -
                        compensationShift
                )
            }
        }
    ...
    ChartModel.prototype._internal_recalculateAllPanes = function () {
        ...
        this._private__panes.forEach(function (p) {
            return p._internal_recalculate()
        })
        this._internal_updateCrosshair()
    }
    ChartModel.prototype._internal_destroy = function () {
        this._private__panes.forEach(function (p) {
            return p._internal_destroy()
        })
    ...
    ChartModel.prototype._internal_createSeries = function (
        seriesType,
        options
    ) {
    ...
    ChartModel.prototype._internal_moveSeriesToScale = function (
        series,
        targetScaleId
    ) {
        ...
        if (target === null) {
            ...
            // if move to new pane
            var zOrder =
                target._internal_pane === pane
                    ? series._internal_zorder()
                    : undefined
            target._internal_pane._internal_addDataSource(
                series,
                targetScaleId,
                zOrder
            )
    ...
    ChartModel.prototype._internal_backgroundColorAtYPercentFromTop = function (
        percent
    ) {
        ...
        if (
            this._private__gradientColorsCache === null ||
            this._private__gradientColorsCache._internal_topColor !==
                topColor ||
            this._private__gradientColorsCache._internal_bottomColor !==
                bottomColor
        ) {
            ...
            var cachedValue =
                this._private__gradientColorsCache._internal_colors.get(percent)
            if (cachedValue !== undefined) {
                return cachedValue
            }
        }
        var result = gradientColorAtPercent(
            topColor,
            bottomColor,
            percent / 100
        )
    ...
    ChartModel.prototype._private__paneInvalidationMask = function (
        pane,
        level
    ) {
    ...
    ChartModel.prototype._private__invalidationMaskForSource = function (
        source,
        invalidateType
    ) {
        ...
        return this._private__paneInvalidationMask(
            this._internal_paneForSource(source),
            invalidateType
        )
    }
    ChartModel.prototype._private__invalidate = function (mask) {
        ...
        this._private__panes.forEach(function (pane) {
            return pane._internal_grid()._internal_paneView()._internal_update()
        })
    }
    ChartModel.prototype._private__createSeries = function (
        options,
        seriesType,
        pane
    ) {
    ...
    ChartModel.prototype._private__getBackgroundColor = function (side) {
        ...
        if (
            layoutOptions.background.type === 'gradient' /* VerticalGradient */
        ) {
            return side === 0 /* Top */
...
var Size = /** @class */ (function () {
    ...
    Size.prototype._internal_equals = function (size) {
        return (
            this._internal_w === size._internal_w &&
            this._internal_h === size._internal_h
        )
    }
    return Size
})()
...
function speedPxPerMSec(pos1, pos2, maxSpeed) {
    var speed =
        (pos1._internal_position - pos2._internal_position) /
        (pos1._internal_time - pos2._internal_time)
    return Math.sign(speed) * Math.min(Math.abs(speed), maxSpeed)
}
function durationMSec(speed, dumpingCoeff) {
    var lnDumpingCoeff = Math.log(dumpingCoeff)
    return (
        Math.log((1 /* EpsilonDistance */ * lnDumpingCoeff) / -speed) /
        lnDumpingCoeff
    )
}
var KineticAnimation = /** @class */ (function () {
    ...
    KineticAnimation.prototype._internal_addPosition = function (
        position,
        time
    ) {
    ...
    KineticAnimation.prototype._internal_start = function (position, time) {
        ...
        if (
            time - this._private__position1._internal_time >
            50 /* MaxStartDelay */
        ) {
            return
        }
        ...
        var totalDistance = 0
        var speed1 = speedPxPerMSec(
            this._private__position1,
            this._private__position2,
            this._private__maxSpeed
        )
        var distance1 = distanceBetweenPoints(
            this._private__position1,
            this._private__position2
        )
        ...
        if (this._private__position3 !== null) {
            var speed2 = speedPxPerMSec(
                this._private__position2,
                this._private__position3,
                this._private__maxSpeed
            )
            // stop at this moment if direction of the segment is opposite
            if (Math.sign(speed2) === Math.sign(speed1)) {
                var distance2 = distanceBetweenPoints(
                    this._private__position2,
                    this._private__position3
                )
                ...
                if (this._private__position4 !== null) {
                    var speed3 = speedPxPerMSec(
                        this._private__position3,
                        this._private__position4,
                        this._private__maxSpeed
                    )
                    if (Math.sign(speed3) === Math.sign(speed1)) {
                        var distance3 = distanceBetweenPoints(
                            this._private__position3,
                            this._private__position4
                        )
        ...
        this._private__durationMsecs = durationMSec(
            Math.abs(resultSpeed),
            this._private__dumpingCoeff
        )
    }
    KineticAnimation.prototype._internal_getPosition = function (time) {
        ...
        return (
            startPosition._internal_position +
            (this._private__speedPxPerMsec *
                (Math.pow(this._private__dumpingCoeff, durationMsecs) - 1)) /
                Math.log(this._private__dumpingCoeff)
        )
    }
    KineticAnimation.prototype._internal_finished = function (time) {
        return (
            this._private__animationStartPosition === null ||
            this._private__progressDuration(time) ===
                this._private__durationMsecs
        )
    }
...
var MouseEventHandler = /** @class */ (function () {
    ...
    MouseEventHandler.prototype._private__mouseEnterHandler = function (
        enterEvent
    ) {
        var _this = this
        ...
        {
            var boundMouseMoveHandler_1 =
                this._private__mouseMoveHandler.bind(this)
            this._private__unsubscribeMousemove = function () {
                _this._private__target.removeEventListener(
                    'mousemove',
                    boundMouseMoveHandler_1
                )
            }
        ...
        this._private__processEvent(
            compatEvent,
            this._private__handler._internal_mouseEnterEvent
        )
    }
    ...
    MouseEventHandler.prototype._private__mouseMoveHandler = function (
        moveEvent
    ) {
    ...
    MouseEventHandler.prototype._private__mouseMoveWithDownHandler = function (
        ...
        var xOffset = Math.abs(
            startMouseMovePos._internal_x - compatEvent._internal_pageX
        )
        var yOffset = Math.abs(
            startMouseMovePos._internal_y - compatEvent._internal_pageY
        )
        ...
        if (
            moveExceededManhattanDistance &&
            !this._private__moveExceededManhattanDistance &&
            isTouch
        ) {
            ...
            var isVertDrag =
                ...
                !this._private__options._internal_treatVertTouchDragAsPageScroll
            var isHorzDrag =
                correctedXOffset > yOffset &&
                !this._private__options._internal_treatHorzTouchDragAsPageScroll
        ...
        if (!this._private__preventDragProcess) {
            this._private__processEvent(
                compatEvent,
                this._private__handler._internal_pressedMouseMoveEvent
            )
    ...
    MouseEventHandler.prototype._private__mouseUpHandler = function (
        ...
        this._private__processEvent(
            compatEvent,
            this._private__handler._internal_mouseUpEvent
        )
        ++this._private__clickCount
        if (this._private__clickTimeoutId && this._private__clickCount > 1) {
            this._private__processEvent(
                compatEvent,
                this._private__handler._internal_mouseDoubleClickEvent
            )
            this._private__resetClickTimeout()
        } else {
            if (!this._private__cancelClick) {
                this._private__processEvent(
                    compatEvent,
                    this._private__handler._internal_mouseClickEvent
                )
            }
        }
    ...
    MouseEventHandler.prototype._private__mouseDownHandler = function (
        ...
        {
            var boundMouseMoveWithDownHandler_1 =
                this._private__mouseMoveWithDownHandler.bind(this)
            var boundMouseUpHandler_1 = this._private__mouseUpHandler.bind(this)
            var rootElement_1 =
                this._private__target.ownerDocument.documentElement
            this._private__unsubscribeRoot = function () {
                rootElement_1.removeEventListener(
                    'touchmove',
                    boundMouseMoveWithDownHandler_1
                )
                rootElement_1.removeEventListener(
                    'touchend',
                    boundMouseUpHandler_1
                )
                rootElement_1.removeEventListener(
                    'mousemove',
                    boundMouseMoveWithDownHandler_1
            ...
            rootElement_1.addEventListener(
                'touchmove',
                boundMouseMoveWithDownHandler_1,
                { passive: false }
            )
            rootElement_1.addEventListener('touchend', boundMouseUpHandler_1, {
                passive: false,
            })
            this._private__clearLongTapTimeout()
        ...
        this._private__processEvent(
            compatEvent,
            this._private__handler._internal_mouseDownEvent
        )
    ...
    MouseEventHandler.prototype._private__init = function () {
        ...
        this._private__target.addEventListener(
            'mouseenter',
            this._private__mouseEnterHandler.bind(this)
        )
        this._private__target.addEventListener(
            'touchcancel',
            this._private__clearLongTapTimeout.bind(this)
        )
        {
            ...
            var outsideHandler_1 = function (event) {
                ...
                if (
                    event.composed &&
                    _this._private__target.contains(event.composedPath()[0])
                ) {
                    return
                }
                if (
                    event.target &&
                    _this._private__target.contains(event.target)
                ) {
                    return
                }
        ...
        this._private__target.addEventListener(
            'mouseleave',
            this._private__mouseLeaveHandler.bind(this)
        )
        this._private__target.addEventListener(
            'touchstart',
            this._private__mouseDownHandler.bind(this),
            { passive: true }
        )
        if (!mobileTouch) {
            this._private__target.addEventListener(
        ...
        this._private__target.addEventListener('touchmove', function () {}, {
            passive: false,
        })
    }
    MouseEventHandler.prototype._private__initPinch = function () {
        var _this = this
        if (
            this._private__handler._internal_pinchStartEvent === undefined &&
        ...
        this._private__target.addEventListener(
            'touchstart',
            function (event) {
                return _this._private__checkPinchState(event.touches)
            },
            { passive: true }
        )
        this._private__target.addEventListener(
            ...
            function (event) {
                if (
                    ...
                    _this._private__startPinchMiddlePoint === null
                ) {
                    return
                }
                if (
                    _this._private__handler._internal_pinchEvent !== undefined
                ) {
                    ...
                    var scale =
                        currentDistance / _this._private__startPinchDistance
                    _this._private__handler._internal_pinchEvent(
                        _this._private__startPinchMiddlePoint,
                        scale
                    )
    ...
    MouseEventHandler.prototype._private__checkPinchState = function (touches) {
        ...
        if (
            touches.length !== 2 ||
            this._private__pinchPrevented ||
            this._private__longTapActive
        ) {
    ...
    MouseEventHandler.prototype._private__startPinch = function (touches) {
        ...
        this._private__startPinchMiddlePoint = {
            _internal_x:
                (touches[0].clientX -
                    box.left +
                    (touches[1].clientX - box.left)) /
                2,
            _internal_y:
                (touches[0].clientY -
                    box.top +
                    (touches[1].clientY - box.top)) /
                2,
        }
    ...
    MouseEventHandler.prototype._private__mouseLeaveHandler = function (event) {
        ...
        this._private__processEvent(
            compatEvent,
            this._private__handler._internal_mouseLeaveEvent
        )
    }
    MouseEventHandler.prototype._private__longTapHandler = function (event) {
        ...
        this._private__processEvent(
            compatEvent,
            this._private__handler._internal_longTapEvent
        )
        this._private__cancelClick = true
        // long tap is active untill touchend event with 0 touches occured
        this._private__longTapActive = true
    }
    MouseEventHandler.prototype._private__processEvent = function (
        event,
        callback
    ) {
        if (!callback) {
...
var LabelsImageCache = /** @class */ (function () {
    ...
    LabelsImageCache.prototype._internal_paintTo = function (
        ctx,
        text,
        x,
        y,
        ...
        ctx.drawImage(
            label._internal_canvas,
            x,
            y,
            label._internal_width,
            label._internal_height
        )
    }
    LabelsImageCache.prototype._private__getLabelImage = function (ctx, text) {
        ...
        if (this._private__hash.has(text)) {
            ...
            var textWidth = Math.ceil(
                this._private__textWidthCache._internal_measureText(ctx, text)
            )
            var width = ceiledEven(Math.round(textWidth + margin_1 * 2))
            var height_1 = ceiledEven(this._private__fontSize + margin_1 * 2)
            var canvas = createPreconfiguredCanvas(
                document,
                new Size(width, height_1)
            )
            // Allocate new
            item = {
                _internal_text: text,
...
var PriceAxisWidget = /** @class */ (function () {
    function PriceAxisWidget(pane, options, rendererOptionsProvider, side) {
        ...
        this._private__canvasConfiguredHandler = function () {
            _this._private__recreateTickMarksCache(
                _this._private__rendererOptionsProvider._internal_options()
            )
        ...
        this._private__canvasBinding = createBoundCanvas(
            this._private__cell,
            new Size(16, 16)
        )
        this._private__canvasBinding.subscribeCanvasConfigured(
        ...
        canvas.style.left = '0'
        canvas.style.top = '0'
        this._private__topCanvasBinding = createBoundCanvas(
            this._private__cell,
            new Size(16, 16)
        )
        this._private__topCanvasBinding.subscribeCanvasConfigured(
        ...
        var handler = {
            ...
            _internal_pressedMouseMoveEvent:
                this._private__pressedMouseMoveEvent.bind(this),
            _internal_mouseDownOutsideEvent:
                this._private__mouseDownOutsideEvent.bind(this),
            _internal_mouseUpEvent: this._private__mouseUpEvent.bind(this),
            _internal_mouseDoubleClickEvent:
                this._private__mouseDoubleClickEvent.bind(this),
            _internal_mouseEnterEvent:
                this._private__mouseEnterEvent.bind(this),
            _internal_mouseLeaveEvent:
                this._private__mouseLeaveEvent.bind(this),
        }
        this._private__mouseEventHandler = new MouseEventHandler(
            this._private__topCanvasBinding.canvas,
            handler,
            {
    ...
    PriceAxisWidget.prototype._internal_destroy = function () {
        ...
        this._private__topCanvasBinding.unsubscribeCanvasConfigured(
            this._private__topCanvasConfiguredHandler
        )
        this._private__topCanvasBinding.destroy()
        this._private__canvasBinding.unsubscribeCanvasConfigured(
            this._private__canvasConfiguredHandler
        )
        this._private__canvasBinding.destroy()
        if (this._private__priceScale !== null) {
            this._private__priceScale
    ...
    PriceAxisWidget.prototype._internal_lineColor = function () {
        return ensureNotNull(this._private__priceScale)._internal_options()
            .borderColor
    }
    ...
    PriceAxisWidget.prototype._internal_baseFont = function () {
        return makeFont(
            ...
            this._private__options.fontFamily
        )
    }
        ...
        if (tickMarks.length > 0) {
            tickMarkMaxWidth = Math.max(
                this._private__widthCache._internal_measureText(
                    ctx,
                    tickMarks[0]._internal_label
                ),
                this._private__widthCache._internal_measureText(
                    ctx,
                    tickMarks[tickMarks.length - 1]._internal_label
                )
            )
        }
        var views = this._private__backLabels()
        for (var j = views.length; j--; ) {
            var width = this._private__widthCache._internal_measureText(
                ctx,
                views[j]._internal_text()
            )
    ...
    PriceAxisWidget.prototype._internal_setSize = function (size) {
        if (size._internal_w < 0 || size._internal_h < 0) {
            throw new Error(
                'Try to set invalid size to PriceAxisWidget ' +
                    JSON.stringify(size)
            )
        }
        if (
            this._private__size === null ||
            !this._private__size._internal_equals(size)
        ) {
            this._private__size = size
            this._private__canvasBinding.resizeCanvas({
                width: size._internal_w,
                height: size._internal_h,
            })
            this._private__topCanvasBinding.resizeCanvas({
                width: size._internal_w,
                height: size._internal_h,
            })
    ...
    PriceAxisWidget.prototype._internal_setPriceScale = function (priceScale) {
        ...
        priceScale
            ._internal_onMarksChanged()
            ._internal_subscribe(this._private__onMarksChanged.bind(this), this)
    }
    ...
    PriceAxisWidget.prototype._internal_reset = function () {
        ...
        model._internal_resetPriceScale(
            pane,
            ensureNotNull(this._internal_priceScale())
        )
    }
    PriceAxisWidget.prototype._internal_paint = function (type) {
        ...
        if (type !== 1 /* Cursor */) {
            ...
            this._private__drawBackground(
                ctx,
                this._private__canvasBinding.pixelRatio
            )
            this._private__drawBorder(
                ctx,
                this._private__canvasBinding.pixelRatio
        ...
        drawScaled(
            topCtx,
            this._private__topCanvasBinding.pixelRatio,
            function () {
                topCtx.clearRect(0, 0, width, height)
            }
        )
        this._private__drawCrosshairLabel(
            topCtx,
            this._private__topCanvasBinding.pixelRatio
        )
    }
    ...
    PriceAxisWidget.prototype._private__mouseDownEvent = function (e) {
        if (
            this._private__priceScale === null ||
            this._private__priceScale._internal_isEmpty() ||
            !this._private__pane._internal_chart()._internal_options()
        ...
        model._internal_startScalePrice(
            pane,
            this._private__priceScale,
            e._internal_localY
        )
    ...
    PriceAxisWidget.prototype._private__mouseEnterEvent = function (e) {
        ...
        var model = this._private__pane._internal_chart()._internal_model()
        if (
            model._internal_options().handleScale.axisPressedMouseMove.price &&
            !this._private__priceScale._internal_isPercentage() &&
            !this._private__priceScale._internal_isIndexedTo100()
        ) {
    ...
    PriceAxisWidget.prototype._private__backLabels = function () {
        ...
        var addViewsForSources = function (sources) {
            for (var i = 0; i < sources.length; ++i) {
                ...
                var views = source._internal_priceAxisViews(
                    _this._private__pane._internal_state(),
                    priceScale
                )
        ...
        addViewsForSources(
            this._private__pane._internal_state()._internal_orderedSources()
        )
        return res
    }
    PriceAxisWidget.prototype._private__drawBackground = function (
        ctx,
        pixelRatio
    ) {
        var _this = this
    ...
    PriceAxisWidget.prototype._private__drawBorder = function (
        ctx,
        pixelRatio
    ) {
        if (
            this._private__size === null ||
            this._private__priceScale === null ||
            !this._private__priceScale._internal_options().borderVisible
        ) {
            return
        }
        ctx.save()
        ctx.fillStyle = this._internal_lineColor()
        var borderSize = Math.max(
            1,
            Math.floor(
                this._internal_rendererOptions()._internal_borderSize *
                    pixelRatio
            )
        )
        var left
        if (this._private__isLeft) {
            left =
                Math.floor(this._private__size._internal_w * pixelRatio) -
                borderSize
        } else {
            left = 0
        }
        ctx.fillRect(
            ...
            0,
            borderSize,
            Math.ceil(this._private__size._internal_h * pixelRatio)
        )
        ctx.restore()
    }
    PriceAxisWidget.prototype._private__drawTickMarks = function (
        ctx,
        pixelRatio
    ) {
        if (
        ...
        var drawTicks =
            this._private__priceScale._internal_options().borderVisible &&
            this._private__priceScale._internal_options().drawTicks
        var tickMarkLeftX = this._private__isLeft
            ? Math.floor(
                  (this._private__size._internal_w -
                      rendererOptions._internal_tickLength) *
                      pixelRatio -
                      rendererOptions._internal_borderSize * pixelRatio
              )
            : Math.floor(rendererOptions._internal_borderSize * pixelRatio)
        var textLeftX = this._private__isLeft
            ? Math.round(
                  tickMarkLeftX -
                      rendererOptions._internal_paddingInner * pixelRatio
              )
            : Math.round(
                  tickMarkLeftX +
                      rendererOptions._internal_tickLength * pixelRatio +
                      rendererOptions._internal_paddingInner * pixelRatio
              )
        ...
        if (drawTicks) {
            ...
            for (
                ...
                ctx.rect(
                    tickMarkLeftX,
                    Math.round(tickMark._internal_coord * pixelRatio) -
                        tickOffset,
                    tickLength,
                    tickHeight
                )
        ...
        for (
            var _a = 0, tickMarks_2 = tickMarks;
            _a < tickMarks_2.length;
            _a++
        ) {
            var tickMark = tickMarks_2[_a]
            this._private__tickMarksCache._internal_paintTo(
                ctx,
                tickMark._internal_label,
                textLeftX,
                Math.round(tickMark._internal_coord * pixelRatio),
                textAlign
            )
    ...
    PriceAxisWidget.prototype._private__alignLabels = function () {
        ...
        var views = []
        var orderedSources = this._private__priceScale
        ...
        var isDefault =
            this._private__priceScale ===
            paneState._internal_defaultPriceScale()
        if (isDefault) {
            this._private__pane
                ._internal_state()
                ._internal_orderedSources()
        ...
        var updateForSources = function (sources) {
            sources.forEach(function (source) {
                var sourceViews = source._internal_priceAxisViews(
                    paneState,
                    priceScale
                )
        ...
        var top = views.filter(function (view) {
            return view._internal_coordinate() <= center
        })
        var bottom = views.filter(function (view) {
            return view._internal_coordinate() > center
        })
        // sort top from center to top
        top.sort(function (l, r) {
            return r._internal_coordinate() - l._internal_coordinate()
        })
        // share center label
        if (top.length && bottom.length) {
            bottom.push(top[0])
        }
        bottom.sort(function (l, r) {
            return l._internal_coordinate() - r._internal_coordinate()
        })
        views.forEach(function (view) {
            return view._internal_setFixedCoordinate(
                view._internal_coordinate()
            )
        })
    ...
    PriceAxisWidget.prototype._private__drawBackLabels = function (
        ctx,
        pixelRatio
    ) {
        var _this = this
        ...
        views.forEach(function (view) {
            if (view._internal_isAxisLabelVisible()) {
                var renderer = view._internal_renderer(
                    ensureNotNull(_this._private__priceScale)
                )
                ctx.save()
                renderer._internal_draw(
                    ctx,
                    rendererOptions,
                    _this._private__widthCache,
                    size._internal_w,
                    align,
                    pixelRatio
                )
    ...
    PriceAxisWidget.prototype._private__drawCrosshairLabel = function (
        ctx,
        pixelRatio
    ) {
        var _this = this
        ...
        var v = model
            ...
            ._internal_priceAxisViews(pane, this._private__priceScale)
        if (v.length) {
            views.push(v)
        }
    ...
    PriceAxisWidget.prototype._private__setCursor = function (type) {
        this._private__cell.style.cursor =
            type === 1 /* NsResize */ ? 'ns-resize' : 'default'
    }
    ...
    PriceAxisWidget.prototype._private__recreateTickMarksCache = function (
        options
    ) {
        this._private__tickMarksCache._internal_destroy()
        this._private__tickMarksCache = new LabelsImageCache(
            options._internal_fontSize,
            options._internal_color,
            options._internal_fontFamily
        )
    }
...
function drawBackground(renderer, ctx, pixelRatio, isHovered, hitTestData) {
    if (renderer._internal_drawBackground) {
        renderer._internal_drawBackground(
            ctx,
            pixelRatio,
            isHovered,
            hitTestData
...
function sourceTopPaneViews(source, pane) {
    return source._internal_topPaneViews !== undefined
        ? source._internal_topPaneViews(pane)
        : []
}
var PaneWidget = /** @class */ (function () {
    function PaneWidget(chart, state) {
        ...
        this._private__state
            ...
            ._internal_subscribe(
                this._private__onStateDestroyed.bind(this),
                this,
                true
            )
        ...
        var scrollOptions =
            this._internal_chart()._internal_options().handleScroll
        this._private__mouseEventHandler = new MouseEventHandler(
            this._private__topCanvasBinding.canvas,
            this,
            {
                _internal_treatVertTouchDragAsPageScroll:
                    !scrollOptions.vertTouchDrag,
                _internal_treatHorzTouchDragAsPageScroll:
                    !scrollOptions.horzTouchDrag,
            }
        )
    }
    ...
    PaneWidget.prototype._internal_setState = function (pane) {
        ...
        if (this._private__state !== null) {
            this._private__state
                ._internal_onDestroyed()
                ._internal_subscribe(
                    PaneWidget.prototype._private__onStateDestroyed.bind(this),
                    this,
                    true
                )
        }
    ...
    PaneWidget.prototype._internal_updatePriceAxisWidgets = function () {
        ...
        if (this._private__leftPriceAxisWidget !== null) {
            ...
            this._private__leftPriceAxisWidget._internal_setPriceScale(
                ensureNotNull(leftPriceScale)
            )
        }
        if (this._private__rightPriceAxisWidget !== null) {
            var rightPriceScale =
                this._private__state._internal_rightPriceScale()
            this._private__rightPriceAxisWidget._internal_setPriceScale(
                ensureNotNull(rightPriceScale)
            )
        }
    }
    PaneWidget.prototype._internal_stretchFactor = function () {
        return this._private__state !== null
            ? this._private__state._internal_stretchFactor()
            : 0
    }
    ...
    PaneWidget.prototype._internal_mouseDownEvent = function (event) {
        ...
        if (
            priceScale._internal_isEmpty() ||
            model._internal_timeScale()._internal_isEmpty()
        ) {
            return
        }
        if (this._private__startTrackPoint !== null) {
            ...
            this._private__startTrackPoint = {
                x: event._internal_localX,
                y: event._internal_localY,
            }
        }
        if (!mobileTouch) {
            this._private__setCrosshairPosition(
                event._internal_localX,
                event._internal_localY
            )
        }
    }
    PaneWidget.prototype._internal_mouseMoveEvent = function (event) {
        ...
        if (!mobileTouch) {
            ...
            this._private__model()._internal_setHoveredSource(
                hitTest && {
    ...
    PaneWidget.prototype._internal_pressedMouseMoveEvent = function (event) {
        ...
        if (
            (!scrollOptions.pressedMouseMove ||
                event._internal_type === 'touch') &&
        ...
        if (this._private__scrollXAnimation !== null) {
            this._private__scrollXAnimation._internal_addPosition(
                event._internal_localX,
                now
            )
        }
        if (
            ...
            if (
                this._private__scrollXAnimation === null &&
                ((event._internal_type === 'touch' &&
                    kineticScrollOptions.touch) ||
                    (event._internal_type === 'mouse' &&
                        kineticScrollOptions.mouse))
            ) {
                this._private__scrollXAnimation = new KineticAnimation(
                    0.2 /* MinScrollSpeed */,
                    7 /* MaxScrollSpeed */,
                    0.997 /* DumpingCoeff */,
                    15 /* ScrollMinMove */
                ...
                this._private__scrollXAnimation._internal_addPosition(
                    this._private__startScrollingPos._internal_localX,
                    this._private__startScrollingPos._internal_timestamp
                )
                this._private__scrollXAnimation._internal_addPosition(
                    event._internal_localX,
                    now
    ...
    PaneWidget.prototype._internal_longTapEvent = function (event) {
        ...
        if (
            this._private__startTrackPoint === null &&
            trackCrosshairOnlyAfterLongTap
        ) {
    ...
    PaneWidget.prototype._internal_pinchEvent = function (middlePoint, scale) {
        ...
        this._private__model()._internal_zoomTime(
            middlePoint._internal_x,
            zoomScale
        )
    }
    PaneWidget.prototype._internal_hitTest = function (x, y) {
        ...
        for (var _i = 0, sources_1 = sources; _i < sources_1.length; _i++) {
            var source = sources_1[_i]
            var sourceResult = this._private__hitTestPaneView(
                source._internal_paneViews(state),
                x,
                y
            )
    ...
    PaneWidget.prototype._internal_setPriceAxisSize = function (
        width,
        position
    ) {
        var priceAxisWidget =
        ...
        ensureNotNull(priceAxisWidget)._internal_setSize(
            new Size(width, this._private__size._internal_h)
        )
    }
    ...
    PaneWidget.prototype._internal_recalculatePriceScales = function () {
        ...
        for (
            var _i = 0, _a = pane._internal_dataSources();
            _i < _a.length;
            _i++
        ) {
            var source = _a[_i]
    ...
    PaneWidget.prototype._internal_paint = function (type) {
        ...
        if (type !== 1 /* Cursor */) {
            ...
            if (this._private__state) {
                this._private__drawGrid(
                    ctx,
                    this._private__canvasBinding.pixelRatio
                )
                this._private__drawWatermark(
                    ctx,
                    this._private__canvasBinding.pixelRatio
                )
        ...
        topCtx.clearRect(
            ...
            Math.ceil(
                this._private__size._internal_h *
                    this._private__topCanvasBinding.pixelRatio
            )
        )
        this._private__drawSources(
        ...
        drawScaled(ctx, pixelRatio, function () {
            ...
            if (topColor === bottomColor) {
                clearRect(
                    ...
                    0,
                    0,
                    _this._private__size._internal_w,
                    _this._private__size._internal_h,
                    bottomColor
                )
            } else {
                clearRectWithGradient(
    ...
    PaneWidget.prototype._private__drawGrid = function (ctx, pixelRatio) {
        ...
        var renderer = paneView._internal_renderer(
            state._internal_height(),
            state._internal_width()
        )
        if (renderer !== null) {
            ctx.save()
    ...
    PaneWidget.prototype._private__drawCrosshair = function (ctx, pixelRatio) {
        this._private__drawSourceImpl(
            ...
            sourcePaneViews,
            drawForeground,
            this._private__model()._internal_crosshairSource()
        )
    }
    PaneWidget.prototype._private__drawSources = function (
        ctx,
        pixelRatio,
        paneViewsGetter
    ) {
    ...
    PaneWidget.prototype._private__drawSourceImpl = function (
        ctx,
        pixelRatio,
        paneViewsGetter,
        drawFn,
        ...
        var isHovered =
            hoveredSource !== null && hoveredSource._internal_source === source
        var objecId =
            hoveredSource !== null &&
            isHovered &&
            hoveredSource._internal_object !== undefined
                ? hoveredSource._internal_object._internal_hitTestData
                : undefined
        for (
            var _i = 0, paneViews_1 = paneViews;
            _i < paneViews_1.length;
            _i++
        ) {
    ...
    PaneWidget.prototype._private__hitTestPaneView = function (
        paneViews,
        x,
        y
    ) {
        for (
            var _i = 0, paneViews_2 = paneViews;
            _i < paneViews_2.length;
            _i++
        ) {
    ...
    PaneWidget.prototype._private__recreatePriceAxisWidgets = function () {
        ...
        if (leftAxisVisible && this._private__leftPriceAxisWidget === null) {
            ...
            this._private__leftAxisCell.appendChild(
                this._private__leftPriceAxisWidget._internal_getElement()
            )
        }
        if (rightAxisVisible && this._private__rightPriceAxisWidget === null) {
            ...
            this._private__rightAxisCell.appendChild(
                this._private__rightPriceAxisWidget._internal_getElement()
            )
        }
    }
    ...
    PaneWidget.prototype._private__preventScroll = function () {
        return (
            (trackCrosshairOnlyAfterLongTap && this._private__longTap) ||
            this._private__startTrackPoint !== null
        )
    }
    ...
    PaneWidget.prototype._private__setCrosshairPosition = function (x, y) {
        this._private__model()._internal_setAndSaveCurrentPosition(
            this._private__correctXCoord(x),
            this._private__correctYCoord(y),
            ensureNotNull(this._private__state)
        )
    }
    ...
    PaneWidget.prototype._private__startTrackingMode = function (
        startTrackPoint,
        crossHairPosition
    ) {
    ...
    PaneWidget.prototype._private__endScroll = function (event) {
        ...
        if (this._private__scrollXAnimation !== null) {
            this._private__scrollXAnimation._internal_start(
                event._internal_localX,
                startAnimationTime
            )
        }
        if (
            this._private__scrollXAnimation === null ||
            this._private__scrollXAnimation._internal_finished(
                startAnimationTime
            )
        ) {
        ...
        var animationFn = function () {
            ...
            if (!scrollXAnimation._internal_terminated()) {
                ...
                model._internal_scrollTimeTo(
                    scrollXAnimation._internal_getPosition(now)
                )
    ...
    PaneWidget.prototype._private__terminateKineticAnimation = function () {
        var now = performance.now()
        var xAnimationFinished =
            this._private__scrollXAnimation === null ||
            this._private__scrollXAnimation._internal_finished(now)
        if (this._private__scrollXAnimation !== null) {
            if (!xAnimationFinished) {
                this._private__finishScroll()
            }
...
var PriceAxisStub = /** @class */ (function () {
    function PriceAxisStub(side, options, params, borderVisible, bottomColor) {
        ...
        this._private__size = new Size(0, 0)
        this._private__canvasConfiguredHandler = function () {
            return _this._internal_paint(3 /* Full */)
        }
        this._private__isLeft = side === 'left'
        this._private__rendererOptionsProvider =
            params._internal_rendererOptionsProvider
        this._private__options = options
    ...
    PriceAxisStub.prototype._internal_paint = function (type) {
        ...
        if (
            this._private__size._internal_w === 0 ||
            this._private__size._internal_h === 0
        ) {
            return
        }
        this._private__invalidated = false
    ...
    PriceAxisStub.prototype._private__drawBorder = function (ctx, pixelRatio) {
        ...
        var borderSize = Math.floor(
            this._private__rendererOptionsProvider._internal_options()
                ._internal_borderSize * pixelRatio
        )
        var left = this._private__isLeft
            ? Math.round(width * pixelRatio) - borderSize
            : 0
...
var TimeAxisWidget = /** @class */ (function () {
    function TimeAxisWidget(chartWidget) {
        ...
        this._private__chart
            ._internal_model()
            ._internal_priceScalesOptionsChanged()
            ._internal_subscribe(this._private__recreateStubs.bind(this), this)
        this._private__mouseEventHandler = new MouseEventHandler(
            this._private__topCanvasBinding.canvas,
            this,
            {
    ...
    TimeAxisWidget.prototype._internal_mouseDownEvent = function (event) {
        ...
        if (
            model._internal_timeScale()._internal_isEmpty() ||
            !this._private__chart._internal_options().handleScale
    ...
    TimeAxisWidget.prototype._internal_pressedMouseMoveEvent = function (
        event
    ) {
        var model = this._private__chart._internal_model()
        if (
    ...
    TimeAxisWidget.prototype._internal_mouseEnterEvent = function (e) {
        if (
            this._private__chart._internal_model()._internal_options()
    ...
    TimeAxisWidget.prototype._internal_setSizes = function (
        ...
        if (
            !this._private__size ||
            !this._private__size._internal_equals(timeAxisSize)
        ) {
            this._private__size = timeAxisSize
            this._private__canvasBinding.resizeCanvas({
                width: timeAxisSize._internal_w,
                height: timeAxisSize._internal_h,
            })
            this._private__topCanvasBinding.resizeCanvas({
                width: timeAxisSize._internal_w,
                height: timeAxisSize._internal_h,
        ...
        if (this._private__leftStub !== null) {
            this._private__leftStub._internal_setSize(
                new Size(leftStubWidth, timeAxisSize._internal_h)
            )
        }
        if (this._private__rightStub !== null) {
            this._private__rightStub._internal_setSize(
                new Size(rightStubWidth, timeAxisSize._internal_h)
            )
        }
    }
    ...
    TimeAxisWidget.prototype._internal_paint = function (type) {
        ...
        topCtx.clearRect(
            0,
            0,
            Math.ceil(this._private__size._internal_w * pixelRatio),
            Math.ceil(this._private__size._internal_h * pixelRatio)
        )
    ...
    TimeAxisWidget.prototype._private__drawBackground = function (
        ctx,
        pixelRatio
    ) {
        var _this = this
    ...
    TimeAxisWidget.prototype._private__drawBorder = function (ctx, pixelRatio) {
        if (this._private__chart._internal_options().timeScale.borderVisible) {
            ...
            var borderSize = Math.max(
                1,
                Math.floor(
                    this._private__getRendererOptions()._internal_borderSize *
                        pixelRatio
                )
            )
            ctx.fillRect(
    ...
    TimeAxisWidget.prototype._private__drawTickMarks = function (
        ctx,
        pixelRatio
    ) {
        var _this = this
        var tickMarks = this._private__chart
            ._internal_model()
            ._internal_timeScale()
            ._internal_marks()
        ...
        var maxWeight = tickMarks.reduce(
        ...
        if (
            this._private__chart
                ._internal_model()
                ._internal_timeScale()
                ._internal_options().borderVisible
        ) {
            ctx.beginPath()
            var tickLen = Math.round(
                rendererOptions._internal_tickLength * pixelRatio
            )
            for (var index = tickMarks.length; index--; ) {
                var x = Math.round(
                    tickMarks[index]._internal_coord * pixelRatio
                )
        ...
        drawScaled(ctx, pixelRatio, function () {
            ...
            for (
                ...
                if (tickMark._internal_weight < maxWeight) {
                    var coordinate = tickMark._internal_needAlignCoordinate
                        ? _this._private__alignTickMarkLabelCoordinate(
                              ctx,
                              tickMark._internal_coord,
                              tickMark._internal_label
                          )
                        : tickMark._internal_coord
    ...
    TimeAxisWidget.prototype._private__alignTickMarkLabelCoordinate = function (
        ctx,
        coordinate,
        labelText
    ) {
        var labelWidth = this._private__widthCache._internal_measureText(
            ctx,
            labelText
        )
        var labelWidthHalf = labelWidth / 2
    ...
    TimeAxisWidget.prototype._private__drawLabels = function (
        sources,
        ctx,
        pixelRatio
    ) {
        ...
        for (var _i = 0, sources_1 = sources; _i < sources_1.length; _i++) {
            var source = sources_1[_i]
            for (
                var _a = 0, _b = source._internal_timeAxisViews();
                _a < _b.length;
                _a++
            ) {
                var view = _b[_a]
                ctx.save()
                view._internal_renderer()._internal_draw(
                    ctx,
                    rendererOptions,
                    pixelRatio
                )
    ...
    TimeAxisWidget.prototype._private__getRendererOptions = function () {
        ...
        if (rendererOptions._internal_font !== newFont) {
            ...
            rendererOptions._internal_paddingBottom =
                rendererOptions._internal_paddingTop
            rendererOptions._internal_paddingHorizontal = Math.ceil(
                fontSize / 2
            )
            rendererOptions._internal_baselineOffset = Math.round(
                this._private__fontSize() / 5
            )
    ...
    TimeAxisWidget.prototype._private__setCursor = function (type) {
        this._private__cell.style.cursor =
            type === 1 /* EwResize */ ? 'ew-resize' : 'default'
    }
    TimeAxisWidget.prototype._private__recreateStubs = function () {
        var model = this._private__chart._internal_model()
        var options = model._internal_options()
        if (
            !options.leftPriceScale.visible &&
            this._private__leftStub !== null
        ) {
            this._private__leftStubCell.removeChild(
                this._private__leftStub._internal_getElement()
            )
            this._private__leftStub._internal_destroy()
            this._private__leftStub = null
        }
        if (
            !options.rightPriceScale.visible &&
            this._private__rightStub !== null
        ) {
            this._private__rightStubCell.removeChild(
                this._private__rightStub._internal_getElement()
            )
            this._private__rightStub._internal_destroy()
            this._private__rightStub = null
        }
        var rendererOptionsProvider = this._private__chart
            ._internal_model()
            ._internal_rendererOptionsProvider()
        var params = {
        ...
        var borderVisibleGetter = function () {
            return (
                options.leftPriceScale.borderVisible &&
                model._internal_timeScale()._internal_options().borderVisible
            )
        }
        var bottomColorGetter = function () {
            return model._internal_backgroundBottomColor()
        }
        if (
            options.leftPriceScale.visible &&
            this._private__leftStub === null
        ) {
            this._private__leftStub = new PriceAxisStub(
                'left',
                options,
                params,
                borderVisibleGetter,
            ...
            this._private__leftStubCell.appendChild(
                this._private__leftStub._internal_getElement()
            )
        }
        if (
            ...
            this._private__rightStub = new PriceAxisStub(
                'right',
                options,
                params,
                borderVisibleGetter,
            ...
            this._private__rightStubCell.appendChild(
                this._private__rightStub._internal_getElement()
            )
        }
    }
...
var ChartWidget = /** @class */ (function () {
    function ChartWidget(container, options) {
        ...
        this._private__element.addEventListener(
            'wheel',
            this._private__onWheelBound,
            { passive: false }
        )
        this._private__model = new ChartModel(
            this._private__invalidateHandler.bind(this),
            this._private__options
        )
        this._internal_model()
            ._internal_crosshairMoved()
            ._internal_subscribe(
                this._private__onPaneWidgetCrosshairMoved.bind(this),
                this
            )
        this._private__timeAxisWidget = new TimeAxisWidget(this)
        this._private__tableElement.appendChild(
            this._private__timeAxisWidget._internal_getElement()
        )
        ...
        this._private__model
            ...
            ._internal_subscribe(
                this._private__model._internal_fullUpdate.bind(
                    this._private__model
                ),
                this
            )
    ...
    ChartWidget.prototype._internal_destroy = function () {
        ...
        for (
            var _i = 0, _a = this._private__paneWidgets;
            _i < _a.length;
            _i++
        ) {
            var paneWidget = _a[_i]
            this._private__tableElement.removeChild(
                paneWidget._internal_getElement()
            )
        ...
        if (this._private__element.parentElement !== null) {
            this._private__element.parentElement.removeChild(
                this._private__element
            )
        }
        this._private__crosshairMoved._internal_destroy()
        this._private__clicked._internal_destroy()
    }
    ChartWidget.prototype._internal_resize = function (
        width,
        height,
        forceRepaint
    ) {
    ...
    ChartWidget.prototype._internal_paint = function (invalidateMask) {
        ...
        for (var i = 0; i < this._private__paneWidgets.length; i++) {
            this._private__paneWidgets[i]._internal_paint(
    ...
    ChartWidget.prototype._internal_takeScreenshot = function () {
        ...
        var targetCanvas = createPreconfiguredCanvas(
            document,
            new Size(this._private__width, this._private__height)
        )
        ...
        drawScaled(ctx, pixelRatio, function () {
            ...
            var drawPriceAxises = function (position) {
                for (
                    var paneIndex = 0;
                    paneIndex < _this._private__paneWidgets.length;
                    paneIndex++
                ) {
                    var paneWidget = _this._private__paneWidgets[paneIndex]
                    var paneWidgetHeight =
                        paneWidget._internal_getSize()._internal_h
                    var priceAxisWidget = ensureNotNull(
                        position === 'left'
                    ...
                    ctx.drawImage(
                        ...
                        targetX,
                        targetY,
                        priceAxisWidget._internal_getWidth(),
                        paneWidgetHeight
                    )
            ...
            if (_this._private__isLeftAxisVisible()) {
                ...
                targetX = ensureNotNull(
                    firstPane._internal_leftPriceAxisWidget()
                )._internal_getWidth()
            }
            targetY = 0
            for (
                ...
                ctx.drawImage(
                    ...
                    targetX,
                    targetY,
                    paneWidgetSize._internal_w,
                    paneWidgetSize._internal_h
                )
    ...
    ChartWidget.prototype._private__adjustSizeImpl = function () {
        ...
        var paneWidth = Math.max(
            width - leftPriceAxisWidth - rightPriceAxisWidth,
            0
        )
        ...
        var totalPaneHeight =
            height < otherWidgetHeight ? 0 : height - otherWidgetHeight
        var stretchPixels = totalPaneHeight / totalStretch
        var accumulatedHeight = 0
        for (
            var paneIndex = 0;
            paneIndex < this._private__paneWidgets.length;
            ++paneIndex
        ) {
            var paneWidget = this._private__paneWidgets[paneIndex]
            paneWidget._internal_setState(
                this._private__model._internal_panes()[paneIndex]
            )
            var paneHeight = 0
            ...
            if (paneIndex === this._private__paneWidgets.length - 1) {
                ...
                calculatePaneHeight = Math.round(
                    paneWidget._internal_stretchFactor() * stretchPixels
                )
            }
            ...
            if (this._private__isLeftAxisVisible()) {
                paneWidget._internal_setPriceAxisSize(
                    leftPriceAxisWidth,
                    'left'
                )
            }
            ...
            if (paneWidget._internal_state()) {
                this._private__model._internal_setPaneHeight(
                    paneWidget._internal_state(),
                    paneHeight
                )
            }
        }
    ...
    ChartWidget.prototype._private__onMousewheel = function (event) {
        ...
        if (
            (deltaX === 0 || !this._private__options.handleScroll.mouseWheel) &&
        ...
        if (deltaY !== 0 && this._private__options.handleScale.mouseWheel) {
            ...
            var scrollPosition =
                event.clientX -
                this._private__element.getBoundingClientRect().left
    ...
    ChartWidget.prototype._private__drawImpl = function (invalidateMask) {
        ...
        if (
            invalidationType === 3 /* Full */ ||
            invalidationType === 2 /* Light */
        ) {
            var panes = this._private__model._internal_panes()
            for (var i = 0; i < panes.length; i++) {
                if (
                    invalidateMask._internal_invalidateForPane(i)
                        ._internal_autoScale
                ) {
                    panes[i]._internal_momentaryAutoScale()
                }
            }
            var timeScaleInvalidations =
                invalidateMask._internal_timeScaleInvalidations()
            for (
                var _i = 0, timeScaleInvalidations_1 = timeScaleInvalidations;
                _i < timeScaleInvalidations_1.length;
                _i++
            ) {
    ...
    ChartWidget.prototype._private__applyTimeScaleInvalidation = function (
        invalidation
    ) {
        var timeScale = this._private__model._internal_timeScale()
        switch (invalidation._internal_type) {
            case 0 /* FitContent */:
                ...
                break
            case 1 /* ApplyRange */:
                timeScale._internal_setLogicalRange(
                    invalidation._internal_value
                )
                break
            case 2 /* ApplyBarSpacing */:
    ...
    ChartWidget.prototype._private__invalidateHandler = function (
        invalidateMask
    ) {
        var _this = this
        if (this._private__invalidateMask !== null) {
    ...
    ChartWidget.prototype._private__syncGuiWithModel = function () {
        ...
        for (var i = actualPaneWidgetsCount; i < targetPaneWidgetsCount; i++) {
            ...
            paneWidget
                ._internal_clicked()
                ._internal_subscribe(
                    this._private__onPaneWidgetClicked.bind(this),
                    this
                )
            ...
            // }
            // insert paneWidget
            this._private__tableElement.insertBefore(
                paneWidget._internal_getElement(),
                this._private__timeAxisWidget._internal_getElement()
            )
        }
    ...
    ChartWidget.prototype._private__getMouseEventParamsImpl = function (
        index,
        point
    ) {
        ...
        var clientTime
        if (index !== null) {
            var timePoint = this._private__model
                ._internal_timeScale()
        ...
        var hoveredSeries =
            hoveredSource !== null &&
            hoveredSource._internal_source instanceof Series
    ...
    ChartWidget.prototype._private__onPaneWidgetClicked = function (
        time,
        point
    ) {
        var _this = this
        this._private__clicked._internal_fire(function () {
            return _this._private__getMouseEventParamsImpl(time, point)
        })
    }
    ChartWidget.prototype._private__onPaneWidgetCrosshairMoved = function (
        time,
        point
    ) {
        var _this = this
    ...
    ChartWidget.prototype._private__updateTimeAxisVisibility = function () {
        ...
        this._private__timeAxisWidget._internal_getElement().style.display =
            display
    }
...
var DataLayer = /** @class */ (function () {
    ...
    DataLayer.prototype._internal_setSeriesData = function (series, data) {
        ...
        if (data.length !== 0) {
            ...
            var createPlotRow_1 = getSeriesPlotRowCreator(
                series._internal_seriesType()
            )
            seriesRows = data.map(function (item) {
                var time = timeConverter_1(item.time)
                var timePointData = _this._private__pointDataByTimePoint.get(
                    time._internal_timestamp
                )
                if (timePointData === undefined) {
                    // the indexes will be sync later
                    timePointData = createEmptyTimePointData(time)
                    _this._private__pointDataByTimePoint.set(
                        time._internal_timestamp,
                        timePointData
                    )
                    isTimeScaleAffected = true
    ...
    DataLayer.prototype._internal_updateSeriesData = function (series, data) {
        ...
        if (
            ...
            throw new Error(
                'Cannot update oldest data, last time=' +
                    lastSeriesTime._internal_timestamp +
                    ', new time=' +
                    time._internal_timestamp
            )
        }
        var pointDataAtTime = this._private__pointDataByTimePoint.get(
            time._internal_timestamp
        )
        ...
        if (pointDataAtTime === undefined) {
            ...
            this._private__pointDataByTimePoint.set(
                time._internal_timestamp,
                pointDataAtTime
            )
        }
        var createPlotRow = getSeriesPlotRowCreator(
            series._internal_seriesType()
        )
    ...
    DataLayer.prototype._private__updateLastSeriesRow = function (
        ...
        if (
            ...
            plotRow._internal_time._internal_timestamp >
                lastSeriesRow._internal_time._internal_timestamp
        ) {
    ...
    DataLayer.prototype._private__setRowsToSeries = function (
        ...
        if (seriesRows.length !== 0) {
            this._private__seriesRowsBySeries.set(
                series,
                seriesRows.filter(isSeriesPlotRow)
            )
            this._private__seriesLastTimePoint.set(
                series,
                seriesRows[seriesRows.length - 1]._internal_time
            )
        } else {
    ...
    DataLayer.prototype._private__replaceTimeScalePoints = function (
        ...
        for (
            ...
            if (
                oldPoint._internal_time._internal_timestamp !==
                newPoint._internal_time._internal_timestamp
            ) {
        ...
        if (
            ...
            firstChangedPointIndex = Math.min(
                this._private__sortedTimePoints.length,
    ...
    DataLayer.prototype._private__getBaseIndex = function () {
        ...
        this._private__seriesRowsBySeries.forEach(function (data) {
            if (data.length !== 0) {
                baseIndex = Math.max(
                    baseIndex,
                    data[data.length - 1]._internal_index
                )
            }
        })
        return baseIndex
...
function checkPriceLineOptions(options) {
    assert(
        ...
        "the type of 'price' price line's property must be a number, got '" +
            typeof options.price +
            "'"
    )
}
function checkItemsAreOrdered(data, allowDuplicates) {
    ...
    for (var i = 1; i < data.length; ++i) {
        ...
        var checkResult = allowDuplicates
            ? prevTime <= currentTime
            : prevTime < currentTime
        assert(
            checkResult,
            'data must be asc ordered by time, index=' +
                i +
                ', time=' +
                currentTime +
                ', prev time=' +
...
function checkBarItem(type, barItem) {
    ...
    assert(
        ...
        type +
            ' series item data value of open must be a number, got=' +
            typeof barItem.open +
            ', value=' +
            barItem.open
    )
    assert(
        ...
        type +
            ' series item data value of high must be a number, got=' +
            typeof barItem.high +
            ', value=' +
            barItem.high
    )
    assert(
        ...
        type +
            ' series item data value of low must be a number, got=' +
            typeof barItem.low +
            ', value=' +
            barItem.low
    )
    assert(
        ...
        type +
            ' series item data value of close must be a number, got=' +
            typeof barItem.close +
            ', value=' +
            barItem.close
    )
}
function checkLineItem(type, lineItem) {
    ...
    assert(
        ...
        type +
            ' series item data value must be a number, got=' +
            typeof lineItem.value +
            ', value=' +
            lineItem.value
    )
}
...
var SeriesApi = /** @class */ (function () {
    ...
    SeriesApi.prototype.priceToCoordinate = function (price) {
        ...
        return this._internal__series
            ._internal_priceScale()
            ._internal_priceToCoordinate(price, firstValue._internal_value)
    }
    ...
    SeriesApi.prototype.barsInLogicalRange = function (range) {
        ...
        var correctedRange = new TimeScaleVisibleRange(
        ...
        var dataFirstBarInRange = bars._internal_search(
            correctedRange._internal_left(),
            1 /* NearestRight */
        )
        var dataLastBarInRange = bars._internal_search(
        ...
        if (
            ...
            dataFirstBarInRange._internal_index >
                dataLastBarInRange._internal_index
        ) {
            return {
        ...
        var barsAfter =
            dataLastBarInRange === null ||
            dataLastBarInRange._internal_index === dataLastIndex
        ...
        if (dataFirstBarInRange !== null && dataLastBarInRange !== null) {
            result.from =
                dataFirstBarInRange._internal_time._internal_businessDay ||
                dataFirstBarInRange._internal_time._internal_timestamp
            result.to =
                dataLastBarInRange._internal_time._internal_businessDay ||
                dataLastBarInRange._internal_time._internal_timestamp
        }
        return result
    }
    SeriesApi.prototype.setData = function (data) {
        ...
        checkSeriesValuesType(
            this._internal__series._internal_seriesType(),
            data
        )
        this._internal__dataUpdatesConsumer._internal_applyNewData(
    ...
    SeriesApi.prototype.update = function (bar) {
        ...
        this._internal__dataUpdatesConsumer._internal_updateData(
            this._internal__series,
            bar
        )
    }
    SeriesApi.prototype.setMarkers = function (data) {
        ...
        var convertedMarkers = data.map(function (marker) {
            return __assign(__assign({}, marker), {
    ...
    SeriesApi.prototype.priceScale = function () {
        return this._private__priceScaleApiProvider.priceScale(
            this._internal__series._internal_priceScale()._internal_id()
        )
    }
    SeriesApi.prototype.createPriceLine = function (options) {
        ...
        var priceLine =
            this._internal__series._internal_createPriceLine(strictOptions)
        return new PriceLine(priceLine)
    }
    SeriesApi.prototype.removePriceLine = function (line) {
        this._internal__series._internal_removePriceLine(
            line._internal_priceLine()
        )
    }
...
var chartOptionsDefaults = {
    ...
    leftPriceScale: __assign(__assign({}, priceScaleOptionsDefaults), {
        visible: false,
    }),
    rightPriceScale: __assign(__assign({}, priceScaleOptionsDefaults), {
        visible: true,
    }),
...
var PriceScaleApi = /** @class */ (function () {
    ...
    PriceScaleApi.prototype.width = function () {
        ...
        return this._private__chartWidget._internal_getPriceAxisWidth(
            this._private__priceScaleId === 'left' /* Left */ ? 'left' : 'right'
        )
    }
    PriceScaleApi.prototype._private__priceScale = function () {
        return ensureNotNull(
            this._private__chartWidget
                ._internal_model()
                ._internal_findPriceScale(this._private__priceScaleId)
        )._internal_priceScale
    }
...
var TimeScaleApi = /** @class */ (function () {
    ...
    TimeScaleApi.prototype.getVisibleRange = function () {
        ...
        return {
            from:
                (_a = timeRange.from._internal_businessDay) !== null &&
                _a !== void 0
                    ? _a
                    : timeRange.from._internal_timestamp,
            to:
                (_b = timeRange.to._internal_businessDay) !== null &&
                _b !== void 0
                    ? _b
                    : timeRange.to._internal_timestamp,
        }
    }
    ...
    TimeScaleApi.prototype.unsubscribeVisibleTimeRangeChange = function (
        handler
    ) {
        this._private__timeRangeChanged._internal_unsubscribe(handler)
    }
    TimeScaleApi.prototype.subscribeVisibleLogicalRangeChange = function (
        handler
    ) {
        this._private__logicalRangeChanged._internal_subscribe(handler)
    }
    TimeScaleApi.prototype.unsubscribeVisibleLogicalRangeChange = function (
        handler
    ) {
    ...
    TimeScaleApi.prototype._private__onVisibleBarsChanged = function () {
        if (this._private__timeRangeChanged._internal_hasListeners()) {
            this._private__timeRangeChanged._internal_fire(
                this.getVisibleRange()
            )
        }
    }
    TimeScaleApi.prototype._private__onVisibleLogicalRangeChanged =
        function () {
...
function migratePriceScaleOptions(options) {
    if (options.priceScale) {
        ...
        if (options.priceScale.invertScale !== undefined) {
            options.overlayPriceScales.invertScale =
                options.priceScale.invertScale
        }
        // do not migrate mode for backward compatibility
        if (options.priceScale.scaleMargins !== undefined) {
            options.overlayPriceScales.scaleMargins =
                options.priceScale.scaleMargins
        }
    }
}
...
var ChartApi = /** @class */ (function () {
    function ChartApi(container, options) {
        ...
        this._private__chartWidget
            ._internal_clicked()
            ._internal_subscribe(function (paramSupplier) {
                if (_this._private__clickedDelegate._internal_hasListeners()) {
                    _this._private__clickedDelegate._internal_fire(
                        _this._private__convertMouseParams(paramSupplier())
                    )
                }
            }, this)
        this._private__chartWidget
            ...
            ._internal_subscribe(function (paramSupplier) {
                if (
                    _this._private__crosshairMovedDelegate._internal_hasListeners()
                ) {
                    _this._private__crosshairMovedDelegate._internal_fire(
                        _this._private__convertMouseParams(paramSupplier())
                    )
                }
            }, this)
    ...
    ChartApi.prototype.addBarSeries = function (options) {
        ...
        var series = this._private__chartWidget
            ._internal_model()
            ._internal_createSeries('Bar', strictOptions)
        var res = new SeriesApi(series, this, this)
        this._private__seriesMap.set(res, series)
        this._private__seriesMapReversed.set(series, res)
        return res
    ...
    ChartApi.prototype.addCandlestickSeries = function (options) {
        ...
        var series = this._private__chartWidget
            ._internal_model()
            ._internal_createSeries('Candlestick', strictOptions)
    ...
    ChartApi.prototype.addHistogramSeries = function (options) {
        ...
        var series = this._private__chartWidget
            ._internal_model()
            ._internal_createSeries('Histogram', strictOptions)
        var res = new SeriesApi(series, this, this)
        this._private__seriesMap.set(res, series)
        this._private__seriesMapReversed.set(series, res)
        return res
    ...
    ChartApi.prototype.addLineSeries = function (options) {
        ...
        var series = this._private__chartWidget
            ._internal_model()
            ._internal_createSeries('Line', strictOptions)
        var res = new SeriesApi(series, this, this)
        this._private__seriesMap.set(res, series)
        this._private__seriesMapReversed.set(series, res)
        return res
    ...
    ChartApi.prototype._internal_applyNewData = function (series, data) {
        this._private__sendUpdateToChart(
            this._private__dataLayer._internal_setSeriesData(series, data)
        )
    }
    ChartApi.prototype._internal_updateData = function (series, data) {
        this._private__sendUpdateToChart(
            this._private__dataLayer._internal_updateSeriesData(series, data)
        )
    }
    ...
    ChartApi.prototype.priceScale = function (priceScaleId) {
        if (priceScaleId === undefined) {
            ...
            priceScaleId = this._private__chartWidget
                ._internal_model()
    ...
    ChartApi.prototype._private__convertMouseParams = function (param) {
        ...
        var hoveredSeries =
            param._internal_hoveredSeries === undefined
                ? undefined
                : this._private__mapSeriesToApi(param._internal_hoveredSeries)
        return {
            time:
                param._internal_time &&
                (param._internal_time._internal_businessDay ||
                    param._internal_time._internal_timestamp),
...
function createChart(container, options) {
    ...
    if (isString(container)) {
        ...
        assert(
            element !== null,
            'Cannot find element in DOM with id=' + container
        )
        htmlElement = element
    } else {
